...
Public Class Frm_ManRequMatPrima
    ...
    Private Sub btn_registro_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_registro.Click
        ...
        Dim Lanca As New Frm_RequMatPrima
    ...
    Private Sub preencheDtgRequis()
        ...
        Try
            sqlRequisicao.Append("SELECT DISTINCT(reqnumero, reqdata, requsuario) FROM " & MdlEmpresaUsu._esqEstab & ".requisicao, ")
            sqlRequisicao.Append(MdlEmpresaUsu._esqVinc & ".est0001 e WHERE reqcodprod = e.e_codig AND e.e_materiaprima = TRUE ")
            ...
            While drRequisicao.Read
                ...
                dtg_requisicao.Refresh() : mlinha = Nothing

            End While
            drRequisicao.Close() : cmdRequisicao.CommandText = ""
        Catch ex As Exception
            MsgBox("ERRO no SELECT da REQUISIÇÃO:: " & ex.Message, MsgBoxStyle.Exclamation, "METROSYS")
            Return
        ...
        cmdRequisicao = Nothing : sqlRequisicao = Nothing : mStrLinha = Nothing
    ...
    Private Sub executaRelatRequisicao(ByVal unidadePC As String, ByVal arqSaida As String)
        ...
        Dim mArqTemp As String = "\wged\ConsultaRequisMtPrim.TMP"
        ...
        Dim strLinha As String = "REQUISICAO DE MATÉRIA PRIMA", numRequis As String = dtg_requisicao.CurrentRow.Cells(0).Value
    ...
    Private Sub GravCabecalhoArq(ByVal s As StreamWriter, ByRef shouldReturn As Boolean, _
        ...
        shouldReturn = False
        Try
            s.WriteLine("Loja: " & _clFuncoes.trazNomeLoja(MdlUsuarioLogando._local, _
                        MdlConexaoBD.conectionPadrao) & _clFuncoes.Exibe_StrDireita(Format(Date.Now, "dd/MM/yyyy"), 73))
            s.Write("Requisição: " & numRequis & "   Data: " & dataRequis & "   Usuario: " & usuarioRequis)

        Catch ex As Exception
            MsgBox("Deu erro ao gravar o Cabeçalho da Nota:: " & ex.Message.ToUpper, MsgBoxStyle.Exclamation)
            shouldReturn = True : Return
    ...
    Private Sub gravaItemsNota(ByVal s As StreamWriter, ByVal numRequis As String)
        ...
        sqlItem.Append("SELECT r.reqnumero, r.reqdata, e.e_produt, r.reqqtde, r.reqcodprod FROM " & MdlEmpresaUsu._esqEstab & ".requisicao r ")
        ...
        mNomeProd = Nothing : mQtdeProd = Nothing : mContItens = Nothing : oConnBDGENOV = Nothing
    ...
    Private Sub btn_imprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_imprimir.Click
        ...
        If Me.dtg_requisicao.Rows.Count > INT_mValorZERO AndAlso Me.dtg_requisicao.SelectedCells.Count > 0 Then
            ...
            executaRelatRequisicao("", "\wged\ConsultaRequisMtPrim.txt")
