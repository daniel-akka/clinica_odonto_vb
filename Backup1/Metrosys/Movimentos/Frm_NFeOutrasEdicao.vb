...
Public Class Frm_NFeOutrasEdicao
    ...
    Public Shared _frmREf As New Frm_NFeOutrasEdicao
    ...
    Public _edicaoNFe As Boolean = True
    ...
    'NF-e:
    Public _numNFePublic, _chaveNFePublic As String
    ...
    Private Sub trazValoresNFe()
        ...
        cbo_estabelecimento.SelectedIndex = _clFuncoes.trazIndexCboLoja(mCodEstab, cbo_estabelecimento)
        cboEstabLeave()
        ...
        Me.txt_codPart.Text = mcodCliente
        ...
        While mDr.Read
            ...
            nota2cc.pNc_numer = mDr(0).ToString
            nota2cc.pNc_codpr = mDr(1).ToString
            nota2cc.pNc_produt = mDr(2).ToString
            nota2cc.pNc_und = mDr(3).ToString
            nota2cc.pNc_qtde = mDr(4)
            nota2cc.pNc_pruvenda = mDr(5)
            nota2cc.pNc_prunit = mDr(6)
            nota2cc.pNc_prtot = mDr(7)
            nota2cc.pNc_cfop = mDr(8).ToString
            nota2cc.pNc_vldesc = mDr(9)
            nota2cc.pNc_frete = mDr(10)
            nota2cc.pNc_segur = mDr(11)
            nota2cc.pNc_descpac = mDr(12)
            nota2cc.pNc_bcalc = mDr(13)
            nota2cc.pNc_alqicm = mDr(14)
            nota2cc.pNc_vlicm = mDr(15)
            nota2cc.pNc_basesub = mDr(16)
            nota2cc.pNc_alqsub = mDr(17)
            nota2cc.pNc_vlsubs = mDr(18)
            nota2cc.pNc_alqipi = mDr(19)
            nota2cc.pNc_vlipi = mDr(20)
            nota2cc.pNc_cf = mDr(21).ToString
            nota2cc.pNc_cst = mDr(22).ToString
            nota2cc.pNc_isento = mDr(23)
            nota2cc.pNc_csosn = mDr(24).ToString
            nota2cc.pNc_vltrib = mDr(25)
            nota2cc.pNc_ncm = mDr(26).ToString
            nota2cc.pNc_desc = mDr(27)
            nota2cc.pNc_voutro = mDr(28)
            nota2cc.pNc_reduz = mDr(29)
            nota2cc.pNc_alqreduz = mDr(30)
            nota2cc.pNc_cstpis = mDr(31).ToString
            nota2cc.pNc_cstcofins = mDr(32).ToString
            nota2cc.pNc_cstipi = mDr(33).ToString
            produto.pProdut2 = mDr(34).ToString
            produto.pProdut3 = mDr(35).ToString
            produto.pPesobruto = mDr(36)
            produto.pPesoliq = mDr(37)
            If nota2cc.pNc_pruvenda = 0 Then nota2cc.pNc_pruvenda = Round((nota2cc.pNc_prtot + nota2cc.pNc_vldesc) / nota2cc.pNc_qtde, 3)
            ...
            dtg_itensNFe.Rows.Add(nota2cc.pNc_codpr, nota2cc.pNc_produt, nota2cc.pNc_und, Format(nota2cc.pNc_qtde, "###,##0.00"), _
                                  Format(nota2cc.pNc_pruvenda, "###,##0.000"), Format(nota2cc.pNc_prunit, "###,##0.000"), _
                                  Format(nota2cc.pNc_prtot, "###,##0.00"), nota2cc.pNc_cfop, Format(nota2cc.pNc_vldesc, "###,##0.00"), _
                                  Format(nota2cc.pNc_frete, "###,##0.00"), Format(nota2cc.pNc_segur, "###,##0.00"), _
                                  Format(nota2cc.pNc_descpac, "###,##0.00"), Format(nota2cc.pNc_bcalc, "###,##0.00"), _
                                  Format(nota2cc.pNc_alqicm, "###,##0.00"), Format(nota2cc.pNc_vlicm, "###,##0.00"), _
                                  Format(nota2cc.pNc_basesub, "###,##0.00"), Format(nota2cc.pNc_alqsub, "###,##0.00"), _
                                  Format(nota2cc.pNc_vlsubs, "###,##0.00"), Format(nota2cc.pNc_alqipi, "###,##0.00"), _
                                  Format(nota2cc.pNc_vlipi, "###,##0.00"), nota2cc.pNc_cf, nota2cc.pNc_cst, nota2cc.pNc_isento, _
        ...
        mConexao.ClearPool() : mConexao.Close() : mConexao = Nothing
    End Sub
        ...
        Try
            ...
            If _prodEditando Then
                ...
                If CDbl(txt_qtde.Text) <> _qtdeAnteriorProd Then
                    ...
                    Select Case tipoNFe
                        Case "E" 'Entrada
                            cl_BD.somaQtdFiscProdEstloja(nota2cc.pNc_codpr, codLoja, mNovaQtde, MdlConexaoBD.conectionPadrao)
                            cl_BD.somaQtdeProdEstloja(nota2cc.pNc_codpr, codLoja, mNovaQtde, MdlConexaoBD.conectionPadrao)
                        ...
                        Case "S" 'Saida
                            ...
                            If qtdeFiscalAtual < nota2cc.pNc_qtde Then
                                ...
                                If genp001.sldfiscalnegativo Then
                                    cl_BD.subtraiQtdFiscProdEstloja(nota2cc.pNc_codpr, codLoja, mNovaQtde, MdlConexaoBD.conectionPadrao)
                                    cl_BD.subtraiQtdeProdEstloja(nota2cc.pNc_codpr, codLoja, mNovaQtde, MdlConexaoBD.conectionPadrao)
                                Else
                ...
                Dim mlinha As String() = {nota2cc.pNc_codpr, nota2cc.pNc_produt, produto.pUnd, Me.txt_qtde.Text, Me.txt_pruvenda.Text, _
...
#Region "   *** Tratamento da NF-e ***   "
    ...
    Private Sub incluiRegistroNFe(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, ByRef ok As Boolean)
        ...
        nota6hh.pC_compl1 = txt_complemento1.Text
        nota6hh.pC_compl2 = txt_complemento2.Text
    ...
    Private Function deletaValoresTabela(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction)
        ...
        nota1pp.pNt_nume = _numNFePublic
        nota2cc.pNc_numer = _numNFePublic
        nota4dd.pN4_numer = _numNFePublic
        nota5tt.pT_numer = _numNFePublic
        nota6hh.pC_numer = _numNFePublic
        resn4dd01.r4_numero = _numNFePublic
        resn4dd02.r4_numero = _numNFePublic
        resn4dd03.r4_numero = _numNFePublic
