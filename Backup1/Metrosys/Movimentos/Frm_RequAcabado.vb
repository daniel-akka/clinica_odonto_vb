...
Public Class Frm_RequAcabado
    ...
    Private Sub Frm_RequAcabado_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                For Each row As DataGridViewRow In Me.dtg_lancamento.Rows
                    ...
                    If Not row.IsNewRow Then
                        ...
                        _clBD.somaQtdeProdEstloja(mCodProdRequis, _local, mQtdeRequisicao, conexao, transacao)
                        '_clBD.somaQtdFiscProd(mCodProdRequis, _local, mQtdeRequisicao, conexao, transacao)
                    End If
                Next
                ...
                If tudoOK = True Then
                    ...
                    _clBD.updateGenp001CodRequis(conexao, String.Format("{0:D12}", Convert.ToInt32(mNumRequisicao)), MdlEmpresaUsu._codigo)
                    transacao.Commit()
    ...
    Private Sub Frm_RequAcabado_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub Frm_RequAcabado_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
