...
Public Class Frm_ManReqTransferencia
    ...
    Private Sub btn_registro_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_registro.Click
        ...
        Dim Lanca As New Frm_ReqTransferencia
        Lanca.ShowDialog() : preencheDtgRequis()
    ...
    Private Sub Frm_ManReqTransferencia_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub Frm_ManReqTransferencia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub preencheDtgRequis()
        ...
        Try
            sqlRequisicao.Append("SELECT DISTINCT(reqnumero, reqdata, requsuario), reqcoddestino, reqnomedestino FROM " & MdlEmpresaUsu._esqEstab & ".reqtransf, ")
            sqlRequisicao.Append(MdlEmpresaUsu._esqVinc & ".est0001 e WHERE reqcodprod = e.e_codig AND e.e_materiaprima = FALSE ")
            sqlRequisicao.Append("AND reqdata BETWEEN '" & msk_dataInicial.Text & "' AND ")
            ...
            While drRequisicao.Read
                ...
                'Adicionando Linha
                Me.dtg_requisicao.Rows.Add(mlinha(0).ToString, drRequisicao(2).ToString, _
            ...
            End While
            drRequisicao.Close() : cmdRequisicao.CommandText = ""
            conexao.ClearPool()
        ...
        daRequisicao = Nothing : cmdRequisicao = Nothing : sqlRequisicao = Nothing
        Me.dtg_requisicao.Focus() : conexao.Close() : conexao = Nothing
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Dim NumChars As Integer, NumLines As Integer
    ...
    Private Sub executaRelatRequisicao(ByVal unidadePC As String, ByVal arqSaida As String)
        ...
        Dim mArqTemp As String = "\wged\ConsultaRequisAcabado.TMP"
        ...
        Dim dataRequis As String = dtg_requisicao.CurrentRow.Cells(2).Value
        Dim usuarioRequis As String = dtg_requisicao.CurrentRow.Cells(3).Value
    ...
    Private Sub LerOArquivoSalvo(ByVal arqSaida As String)
        ...
        Try
            ...
            MyfileStream.Close() : MyfileStream.Dispose()
    ...
    Private Sub GravCabecalhoArq(ByVal s As StreamWriter, ByRef shouldReturn As Boolean, _
        ...
        shouldReturn = False
        Try
            s.WriteLine(_clFuncoes.Exibe_StrEsquerda("Loja: " & _clFuncoes.trazNomeLoja(MdlUsuarioLogando._local, _
                        MdlConexaoBD.conectionPadrao), 70) & _clFuncoes.Exibe_StrDireita(Format(Date.Now, "dd/MM/yyyy"), 22))

            s.WriteLine(_clFuncoes.Exibe_StrEsquerda("Destino.: " & dtg_requisicao.CurrentRow.Cells(1).Value.ToString, 92))
    ...
    Private Sub gravaItemsNota(ByVal s As StreamWriter, ByVal numRequis As String)
        ...
        sqlItem.Append("SELECT r.reqnumero, r.reqdata, e.e_produt, r.reqqtde, r.reqcodprod FROM " & MdlEmpresaUsu._esqEstab & ".reqtransf r ")
        sqlItem.Append("LEFT JOIN " & MdlEmpresaUsu._esqVinc & ".est0001 e ON e.e_codig = r.reqcodprod WHERE r.reqnumero = ")
        ...
        If drItem.HasRows = True Then
            ...
            s.WriteLine("--------------------------------------------------------------------------------------------")
            s.WriteLine("CÓDIGO   PRODUTO                                            QUANTIDADE ")
        ...
        While drItem.Read
            ...
            mNomeProd = drItem(2) : mQtdeProd = drItem(3) : mCodProd = drItem(4)

            strLinha = _clFuncoes.Exibe_StrEsquerda(mCodProd, 6) & "   " & _
            _clFuncoes.Exibe_StrEsquerda(mNomeProd, 52) & _
            _clFuncoes.Exibe_StrEsquerda(Format(mQtdeProd, "###,##0.00"), 20)
    ...
    Private Sub btn_imprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_imprimir.Click
        ...
        If Me.dtg_requisicao.Rows.Count > INT_mValorZERO AndAlso Me.dtg_requisicao.SelectedCells.Count > 0 Then
            ...
            executaRelatRequisicao("", "\wged\ConsultaRequisAcabado.txt")
