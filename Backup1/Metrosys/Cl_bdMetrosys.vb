...
#Region "  * * Manutenção da Fatd001 * *  "
    ...
    Public Sub incFatd001RetornoMp(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
        ...
        Try
            comm.Parameters.Add("@f_emiss", CDate(f_emiss))
        Catch ex As Exception
            comm.Parameters.Add("@f_emiss", System.DBNull.Value)
        End Try

        Try
            comm.Parameters.Add("@f_vencto", CDate(f_vencto))
        Catch ex As Exception
            comm.Parameters.Add("@f_vencto", System.DBNull.Value)
        End Try
    ...
    Public Sub atualTodasSitPartFatd001(ByVal connection As NpgsqlConnection, _
        ...
        comm.Parameters.Add("@f_portad", codPart)
        comm.Parameters.Add("@f_dtpaga", dtPagamento)
    ...
    Public Sub IncCarne_a_Receber(ByVal Geno As String, ByVal Portador As String, ByVal tipo As String, ByVal nfat As String, ByVal nfisc As String, ByVal serie As String, _
        ...
        Try
            ...
            sqlbuild.Append("f_ctareduz,f_nnumero, f_imp, f_mtransm, f_vend, f_valorpago, f_valordevido, f_comissao) ")
            ...
            sqlbuild.Append("@f_valordevido, @f_comissao)")
            ...
            comm.Parameters.Add("@f_emiss", emiss)
            comm.Parameters.Add("@f_vencto", vencto)
            comm.Parameters.Add("@f_valor", valor)
            comm.Parameters.Add("@f_cartei", cartei)
            comm.Parameters.Add("@f_dtpaga", System.DBNull.Value) ' confirmar registro
...
#Region "* *  Manutenção de Usuário  * *"
    ...
    Public Sub incUsuario(ByVal objUsuario As Cl_Usuario, ByVal conexao As NpgsqlConnection, _
        ...
        Try
            comm.Parameters.Add("@u_datanascimento", CDate(objUsuario.pDataNascimento))
        Catch ex As Exception
            comm.Parameters.Add("@u_datanascimento", System.DBNull.Value)
        End Try
    ...
    Public Sub altUsuario(ByVal objUsuario As Cl_Usuario, ByVal idUsuario As Int32, ByVal conexao As NpgsqlConnection, _
        ...
        comm.Parameters.Add("@u_privilegio", objUsuario.pPrivilegio)
        comm.Parameters.Add("@u_bloqueado", objUsuario.pBloqueado)
        comm.Parameters.Add("@u_datanascimento", objUsuario.pDataNascimento)
        comm.Parameters.Add("@u_local", objUsuario.pLocal)
        comm.Parameters.Add("@u_codvendedor", objUsuario.pCodVendedor)
        comm.Parameters.Add("@u_cargo", objUsuario.pCargo)
        comm.Parameters.Add("@u_codcaixa", objUsuario.pCodCaixa)
    ...
    Public Sub incUsuarioTelas(ByVal objUsuarioTelas As Cl_UsuarioTelas, ByVal conexao As NpgsqlConnection, _
        ...
        sqlbuild.Append("tl_paraconfiguracao, tl_pagoaentregar, btn_carne)")
    ...
    Public Sub altUsuarioTelas(ByVal objUsuarioTelas As Cl_UsuarioTelas, ByVal conexao As NpgsqlConnection, _
        ...
        sqlbuild.Append("tl_pagoaentregar = @tl_pagoaentregar, btn_carne = @btn_carne WHERE tl_idusuario = @tl_idusuario")
...
#Region "*  *  Manutenção de EstFinanceiro  *  *"
    ...
    Public Sub incEstFinanceiro(ByVal objEstFinanceiro As Cl_EstFinanceiro, ByVal conexao As NpgsqlConnection, _
        ...
        Try
            comm.Parameters.Add("@ef_data", CDate(objEstFinanceiro.pData))
        Catch ex As Exception
            comm.Parameters.Add("@ef_data", System.DBNull.Value)
        End Try
...
#Region "  * * Manutenção de Gerente * *  "
    ...
    Public Function trazLibDescGerente(ByVal conexao As NpgsqlConnection, _
        ...
        dr.Close() : conexao.ClearPool() : comm = Nothing : dr = Nothing : sqlcmd = Nothing
...
#Region "* *  Manutenção de Vendedor  * *"

    Public Sub incVendedor(ByVal objVendedor As Cl_Vendedor, ByVal conexao As NpgsqlConnection, _
                           ByVal transacao As NpgsqlTransaction)

        Dim comm As New NpgsqlCommand
        Dim sqlbuild As New StringBuilder

        sqlbuild.Append("INSERT INTO cadvendedor(")
        sqlbuild.Append("v_id, v_codigo, v_nome, v_endereco, v_uf, v_cidade, v_bairro, v_fone, v_celular, ")
        sqlbuild.Append("v_comissionado, v_tipocomissao, v_alqcomiss, v_descmax, v_mensagem, v_rota, ")
        sqlbuild.Append("v_supervisor, v_senha, v_local, v_tipo, v_dispositivo)")
        sqlbuild.Append("VALUES (DEFAULT, @v_codigo, @v_nome, @v_endereco, @v_uf, @v_cidade, @v_bairro, ")
        sqlbuild.Append("@v_fone, @v_celular, @v_comissionado, @v_tipocomissao, @v_alqcomiss, @v_descmax, ")
        sqlbuild.Append("@v_mensagem, @v_rota, @v_supervisor, @v_senha, @v_local, @v_tipo, @v_dispositivo);") 'LO_IMPORT( @v_foto )

        comm = New NpgsqlCommand(sqlbuild.ToString, conexao)

        comm.Transaction = transacao
        ' Prepara Paramentros
        comm.Parameters.Add("@v_codigo", objVendedor.pCodigo)
        comm.Parameters.Add("@v_nome", objVendedor.pNome)
        comm.Parameters.Add("@v_endereco", objVendedor.pEndereco)
        comm.Parameters.Add("@v_uf", objVendedor.pUf)
        comm.Parameters.Add("@v_cidade", objVendedor.pCidade)
        comm.Parameters.Add("@v_bairro", objVendedor.pBairro)
        comm.Parameters.Add("@v_fone", objVendedor.pFone)
        comm.Parameters.Add("@v_celular", objVendedor.pCelular)
        comm.Parameters.Add("@v_comissionado", objVendedor.pComissionado)
        comm.Parameters.Add("@v_tipocomissao", objVendedor.pTipocomissao)
        comm.Parameters.Add("@v_alqcomiss", objVendedor.pAlqcomiss)
        comm.Parameters.Add("@v_descmax", objVendedor.pDescMAx)
        comm.Parameters.Add("@v_mensagem", objVendedor.pMensagem)
        comm.Parameters.Add("@v_rota", objVendedor.pRota)
        comm.Parameters.Add("@v_supervisor", objVendedor.pSupervisor)
        comm.Parameters.Add("@v_senha", objVendedor.pSenha)
        'comm.Parameters.Add("@v_foto", objVendedor.pfoto) 'NpgsqlTypes.LargeObject)
        comm.Parameters.Add("@v_local", objVendedor.pLocal)
        comm.Parameters.Add("@v_tipo", objVendedor.pTipo)
        comm.Parameters.Add("@v_dispositivo", objVendedor.dispositivo)
    ...
    Public Sub altVendedor(ByVal objVendedor As Cl_Vendedor, ByVal conexao As NpgsqlConnection, _
                           ByVal transacao As NpgsqlTransaction, ByVal idVendedor As Int32)

        Dim comm As New NpgsqlCommand
        Dim sqlbuild As New StringBuilder

        sqlbuild.Append("UPDATE cadvendedor ")
        sqlbuild.Append("SET v_nome = @v_nome, v_endereco = @v_endereco, v_uf = @v_uf, v_cidade = @v_cidade, ")
        sqlbuild.Append("v_bairro = @v_bairro, v_fone = @v_fone, v_celular = @v_celular, v_comissionado = @v_comissionado, ")
        sqlbuild.Append("v_tipocomissao = @v_tipocomissao, v_alqcomiss = @v_alqcomiss, v_descmax = @v_descmax, ")
        sqlbuild.Append("v_mensagem = @v_mensagem, v_rota = @v_rota, v_supervisor = @v_supervisor, v_senha = @v_senha, ")
        sqlbuild.Append("v_local = @v_local, v_tipo = @v_tipo, v_dispositivo = @v_dispositivo ") 'v_foto = @v_foto, 
        sqlbuild.Append("WHERE v_id = @v_id")
        comm = New NpgsqlCommand(sqlbuild.ToString, conexao)

        comm.Transaction = transacao
        ' Prepara Paramentros
        comm.Parameters.Add("@v_id", idVendedor)
        'comm.Parameters.Add("@v_codigo", codigo)
        comm.Parameters.Add("@v_nome", objVendedor.pNome)
        comm.Parameters.Add("@v_endereco", objVendedor.pEndereco)
        comm.Parameters.Add("@v_uf", objVendedor.pUf)
        comm.Parameters.Add("@v_cidade", objVendedor.pCidade)
        ...
        comm.Parameters.Add("@v_supervisor", objVendedor.pSupervisor)
        comm.Parameters.Add("@v_senha", objVendedor.pSenha)
        'comm.Parameters.Add("@v_foto", objVendedor.pfoto)
        comm.Parameters.Add("@v_local", objVendedor.pLocal)
        comm.Parameters.Add("@v_tipo", objVendedor.pTipo)
        comm.Parameters.Add("@v_dispositivo", objVendedor.dispositivo)
    ...
    Public Sub altLojaVendedor(ByVal loja As String, ByVal codVendedor As String, _
        ...
        sqlbuild.Append("UPDATE cadvendedor ")
        sqlbuild.Append("SET v_local = @v_local WHERE v_codigo = @v_codigo")
        comm = New NpgsqlCommand(sqlbuild.ToString, conexao)

        comm.Transaction = transacao
        ' Prepara Paramentros
        comm.Parameters.Add("@v_codigo", codVendedor)
        comm.Parameters.Add("@v_local", loja)
    ...
    Public Function trazDescVendedor(ByVal strConection As String, _
                                     ByVal codVendedor As String) As Double
        ...
        Try
            oConnection.Open()
        Catch ex As Exception
            MsgBox(ex.Message) : Return 0.0
        End Try

        Dim mvalorDesc As Double
        Dim comm As New NpgsqlCommand
        Dim dr As NpgsqlDataReader
        Dim sqlcmd As String = "SELECT v_descmax FROM cadvendedor WHERE v_codigo = @v_codigo;"

        comm = New NpgsqlCommand(sqlcmd, oConnection)
        comm.Parameters.Add("@v_codigo", codVendedor)
        dr = comm.ExecuteReader
        While dr.Read
        ...
        oConnection.ClearPool() : oConnection.Close() : oConnection = Nothing
...
#Region "* * *   Manutenção Retorno do Mapa   * * *"
    ...
    Public Sub incRetorno1pp(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
        ...
        comm.Parameters.Add("@rt_dtentegra", dtEntrega)
...
#Region " *  *  *    Caixa, Despesa e Tesouraria    *  *  * "
    ...
    Public Sub incCaixa_lancamento(ByVal ID As Integer, ByVal Tipo As String, ByVal DTEmissao As Date, ByVal Grupo As String, ByVal Descricao As String, ByVal Valor As Double, _
        ...
        Try
            ...
            comm.Parameters.Add("cx_data", DTEmissao)
    ...
    Public Sub crud_DespLancamentos(ByVal Sit As String, ByVal ID As Integer, ByVal firma As String, ByVal grupo As String, ByVal subgrupo As String, _
        ...
        Try
            ...
            comm.Parameters.Add("dm_data", datamov)
    ...
    Public Sub crud_ExcPlanodeContas(ByVal Codigo As String, ByVal conexao As NpgsqlConnection)
...
#Region "  * **Manuteção do estloja01** *  "
    ...
    Public Function existeProdEstloja01(ByVal mCodProd As String, ByVal mLoja As String, _
        ...
        If dr.HasRows = True Then
            ...
            sqlbuild = Nothing : comm = Nothing : dr.Close() : dr = Nothing : connection.ClearPool()
    ...
    Public Sub incEstloja(ByVal loja As String, ByVal idVinculo As Int16, ByVal codig As String, ByVal cdport As String, ByVal qtde As Double, _
        ...
        Try
            dtvalid = CDate(dtvalid.ToString("u"))

            If IsDate(dtvalid.ToString) Then
                comm.Parameters.Add("@e_valid", dtvalid)
            Else
                comm.Parameters.Add("@e_valid", System.DBNull.Value)
            End If
        Catch ex As Exception
            comm.Parameters.Add("@e_valid", System.DBNull.Value)
        End Try
    ...
    Public Sub incTodasEstloja(ByVal vinculo As Int32, ByVal loja As String, ByVal codig As String, ByVal cdport As String, ByVal qtde As Double, _
        ...
        While dr.Read
            ...
            If existeProdEstloja01(codig, loja, conexao) = False Then
                ...
                Try
                    ...
                    If IsDate(dtvalid.ToString) Then
                        commInc.Parameters.Add("@e_valid", dtvalid)
                    Else
                        commInc.Parameters.Add("@e_valid", System.DBNull.Value)
                    End If
                Catch ex As Exception
                    commInc.Parameters.Add("@e_valid", System.DBNull.Value)
                End Try
        ...
        connection.Close() : connection.ClearPool() : connection = Nothing
    End Sub
    ...
    Public Sub altEstloja(ByVal loja As String, ByVal codig As String, ByVal cdport As String, ByVal qtde As Double, _
        ...
        Try
            dtcomp = CDate(dtcomp.ToString("u"))

            If IsDate(dtcomp.ToString) Then
                comm.Parameters.Add("@e_dtcomp", dtcomp)
            Else
                comm.Parameters.Add("@e_dtcomp", System.DBNull.Value)
            End If
        Catch ex As Exception
            comm.Parameters.Add("@e_dtcomp", System.DBNull.Value)
        End Try
        ...
        Try
            dtvend = CDate(dtvend.ToString("u"))

            If IsDate(dtvend.ToString) Then
                comm.Parameters.Add("@e_dtvend", dtvend)
            Else
                comm.Parameters.Add("@e_dtvend", System.DBNull.Value)
            End If
        Catch ex As Exception
            comm.Parameters.Add("@e_dtvend", System.DBNull.Value)
        End Try
...
#Region "  * * Manutenção do Geno001 e Genp001 * *  "
    ...
    Public Sub incGeno001(ByVal objGeno As Cl_Geno, ByVal conexao As NpgsqlConnection, _
        ...
        sqlbuild.Append("g_cofins, g_csll, g_irenda, g_sn) ")
    ...
    Public Sub incGenp001(ByVal objGenp001 As Cl_Genp001, ByVal conexao As NpgsqlConnection, _
        ...
        sqlbuild.Append("gp_ftppalm, gp_usuarioftppalm, gp_senhaftppalm, gp_pauta, gp_descontonfe) ")
        ...
        sqlbuild.Append("@gp_imagemcarne, @gp_sldfiscalnegativo, @gp_aplicacao, ")
        sqlbuild.Append("@gp_tabletenvio, @gp_tabletretorno, @gp_palmenvio, @gp_palmretorno, ")
        sqlbuild.Append("@gp_tabletpathimg, @gp_ftptablet, @gp_usuarioftptablet, @gp_senhaftptablet, ")
        sqlbuild.Append("@gp_ftppalm, @gp_usuarioftppalm, @gp_senhaftppalm, @gp_pauta, @gp_descontonfe) ")
        ...
        Try
            comm.Parameters.Add("@gp_data", CDate(objGenp001.pData))
        Catch ex As Exception
            comm.Parameters.Add("@gp_data", System.DBNull.Value)
        End Try
    ...
    Public Function trazProxCodGeno(ByVal conexao As NpgsqlConnection) As Int32
        ...
        drGeno.Close() : drGeno = Nothing : conexao.ClearPool() : comm = Nothing : sqlcmd = Nothing
    ...
    Public Function existCNPJGeno001(ByVal cnpj As String, ByVal codGeno As String, ByVal conexao As String) As Boolean
        ...
        If drGeno.HasRows = True Then
            ...
            conection.ClearPool() : conection.Close() : conection = Nothing : drGeno.Close()
    ...
    Public Function Caixa_fechado(ByVal DtFechada As Date, ByVal Mtipo As String, ByVal Loja As String, ByVal Caixa As String, _
        ...
        Try
            ...
            Cmd.Parameters.Add("@cx_data", DtFechada)
...
#Region " * * *  Requisição * * *  "
    ...
    Public Sub inclueRequisicao(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
        ...
        comm.Parameters.Add("@reqdata", dataRequis)
...
#Region " * * *  Requisição para Transferência * * *  "
    ...
    Public Sub inclueReqTransferencia(ByVal objReqTransf As Cl_ReqTransferencia, ByVal conexao As NpgsqlConnection, _
        ...
        comm.Parameters.Add("@reqdata", objReqTransf.pReqData)
...
#Region "* * *   Manutenção do Mapa   * * *"
    ...
    Public Sub incMapa1pp(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
        ...
        comm.Parameters.Add("@mv_emissao", dtEmissao)
        comm.Parameters.Add("@mv_saida", dtSaida)
    ...
    Public Sub incMapa1ppr(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
        ...
        comm.Parameters.Add("@mvr_emissao", dtEmissao)
        comm.Parameters.Add("@mvr_saida", dtSaida)
    ...
    Public Function trazIdMapa1pp(ByVal conexao As NpgsqlConnection, ByVal numMapa As String) As Int32
        ...
        drMp.Close() : conexao.ClearPool() : drMp = Nothing : comm = Nothing : sqlcmd = Nothing
...
#Region " * * *   Requisição de Processo   * * * "
    ...
    Public Sub inclueRequProcCli(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
        ...
        comm.Parameters.Add("@r_data", dataRequis)
...
#Region "  * * Manutenção dos Grupos * *  "

    Public Sub incGrupo(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                         ByVal objGrupo As Cl_Grupo)

        Dim comm As New NpgsqlCommand
        Dim sqlbuild As New StringBuilder

        sqlbuild.Append("INSERT INTO estg003(")
        sqlbuild.Append("eg_id, eg_grupo, eg_descri) VALUES (DEFAULT, @eg_grupo, @eg_descri);")

        comm.Transaction = transacao
        comm = New NpgsqlCommand(sqlbuild.ToString, conexao)
        ' Prepara Paramentros
        comm.Parameters.Add("@eg_grupo", objGrupo.pGrupo)
        comm.Parameters.Add("@eg_descri", objGrupo.pDescricao)
    ...
    Public Sub altGrupo(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                          ByVal id As Int32, ByVal objGrupo As Cl_Grupo)

        Dim comm As New NpgsqlCommand
        Dim sqlbuild As New StringBuilder

        sqlbuild.Append("UPDATE estg003 SET ")
        sqlbuild.Append("eg_descri = @eg_descri WHERE eg_id = @eg_id")

        comm.Transaction = transacao
        comm = New NpgsqlCommand(sqlbuild.ToString, conexao)
        ' Prepara Paramentros
        comm.Parameters.Add("@eg_id", id)
        comm.Parameters.Add("@eg_descri", objGrupo.pDescricao)
    ...
    Public Sub delGrupo(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                          ByVal id As Int32)

        Dim comm As New NpgsqlCommand
        Dim sqlbuild As New StringBuilder

        sqlbuild.Append("DELETE FROM estg003 WHERE eg_id = @eg_id")
    ...
    Public Function existeGrupo(ByVal conexao As NpgsqlConnection, ByVal grupo As String) As Boolean

        Dim mexiste As Boolean = False
        Dim comm As New NpgsqlCommand
        Dim dr As NpgsqlDataReader
        Dim sqlcmd As String = "SELECT eg_id FROM estg003 WHERE eg_grupo = @eg_grupo;"

        comm = New NpgsqlCommand(sqlcmd, conexao)
        comm.Parameters.Add("@eg_grupo", grupo)
        dr = comm.ExecuteReader
        If dr.HasRows Then mexiste = True
    ...
    Public Function existeDescGrupo(ByVal conexao As NpgsqlConnection, ByVal descricao As String) As Boolean

        Dim mexiste As Boolean = False
        Dim comm As New NpgsqlCommand
        Dim dr As NpgsqlDataReader
        Dim sqlcmd As String = "SELECT eg_id FROM estg003 WHERE eg_descri = @descricao;"
    ...
    Public Function existeDescGrupoAlt(ByVal conexao As NpgsqlConnection, ByVal descricaoAtual As String, _
                                     ByVal descricaoAnterior As String) As Boolean

        Dim mexiste As Boolean = False
        Dim comm As New NpgsqlCommand
        Dim dr As NpgsqlDataReader
        Dim sqlcmd As String = "SELECT eg_id FROM estg003 WHERE eg_descri <> @descranterior AND " & _
        "eg_descri = @descratual;"
    ...
    Public Function trazNovoGrupo(ByVal strConexao As String) As Integer
        ...
        Dim comm As New NpgsqlCommand
        Dim dr As NpgsqlDataReader
        Dim sqlcmd As String = "SELECT (Max(eg_grupo) + 1) AS ""NovoGrupo"" FROM estg003"

        comm = New NpgsqlCommand(sqlcmd, conexao)
        dr = comm.ExecuteReader

        If dr.HasRows Then grupo = 1
        While dr.Read
        ...
        dr.Close() : conexao.ClearPool() : conexao.Close()
        comm = Nothing : dr = Nothing : sqlcmd = Nothing : conexao = Nothing
...
#Region "  * * Manutenção das Grades * *  "

    Public Sub incGrade(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                         ByVal objGrade As Cl_Grade)

        Dim comm As New NpgsqlCommand
        Dim sqlbuild As New StringBuilder

        sqlbuild.Append("INSERT INTO " & MdlEmpresaUsu._esqVinc & ".estgrade(")
        sqlbuild.Append("e_idgrade, e_codig, e_tm, e_cor, e_qtde, e_loja) VALUES ")
        sqlbuild.Append("(DEFAULT, @e_codig, @e_tm, @e_cor, @e_qtde, @e_loja)")

        comm.Transaction = transacao
        comm = New NpgsqlCommand(sqlbuild.ToString, conexao)
        ' Prepara Paramentros
        comm.Parameters.Add("@e_codig", objGrade.pCodig)
        comm.Parameters.Add("@e_tm", objGrade.pTm)
        comm.Parameters.Add("@e_cor", objGrade.pCor)
        comm.Parameters.Add("@e_qtde", objGrade.pQtde)
        comm.Parameters.Add("@e_loja", objGrade.pLoja)
    ...
    Public Sub altGrade(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                          ByVal objGrade As Cl_Grade)

        Dim comm As New NpgsqlCommand
        Dim sqlbuild As New StringBuilder

        sqlbuild.Append("UPDATE " & MdlEmpresaUsu._esqVinc & ".estgrade SET e_codig = @e_codig, e_tm = @e_tm, ")
        sqlbuild.Append("e_cor = @e_cor, e_qtde = @e_qtde, e_loja = @e_loja WHERE e_idgrade = @e_idgrade")

        comm.Transaction = transacao
        comm = New NpgsqlCommand(sqlbuild.ToString, conexao)
        ' Prepara Paramentros
        comm.Parameters.Add("@e_idgrade", objGrade.pId)
        comm.Parameters.Add("@e_codig", objGrade.pCodig)
        comm.Parameters.Add("@e_tm", objGrade.pTm)
        comm.Parameters.Add("@e_cor", objGrade.pCor)
        comm.Parameters.Add("@e_qtde", objGrade.pQtde)
    ...
    Public Sub delGrade(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                          ByVal objGrade As Cl_Grade)

        Dim comm As New NpgsqlCommand
        Dim sqlbuild As New StringBuilder

        sqlbuild.Append("DELETE FROM " & MdlEmpresaUsu._esqVinc & ".estgrade WHERE e_idgrade = @e_idgrade")
    ...
    Public Sub atualizaQtdeGrade(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                          ByVal objGrade As Cl_Grade)

        Dim comm As New NpgsqlCommand
        Dim sqlbuild As New StringBuilder

        sqlbuild.Append("UPDATE " & MdlEmpresaUsu._esqVinc & ".estgrade SET e_qtde = @e_qtde WHERE e_idgrade = @e_idgrade")
    ...
    Public Sub atualizaQtdeGradeSubtraindo(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                          ByVal objGrade As Cl_Grade)

        Dim comm As New NpgsqlCommand
        Dim sqlbuild As New StringBuilder

        sqlbuild.Append("UPDATE " & MdlEmpresaUsu._esqVinc & ".estgrade SET e_qtde = (e_qtde - @e_qtde) WHERE ")
        sqlbuild.Append("e_codig = @e_codig AND e_tm = @e_tm AND e_cor = @e_cor AND e_loja = @e_loja")
    ...
    Public Sub atualizaQtdeGradeSomando(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                          ByVal objGrade As Cl_Grade)
    ...
    Public Sub atualizaQtdeGradeSomandoId(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                          ByVal qtde As Double, ByVal idGrade As Integer)

        Dim comm As New NpgsqlCommand
        Dim sqlbuild As New StringBuilder

        sqlbuild.Append("UPDATE " & MdlEmpresaUsu._esqVinc & ".estgrade SET e_qtde = (e_qtde + @e_qtde) WHERE ")
        sqlbuild.Append("e_idgrade = @e_idgrade ")

        comm.Transaction = transacao
        comm = New NpgsqlCommand(sqlbuild.ToString, conexao)
        ' Prepara Paramentros
        comm.Parameters.Add("@e_idgrade", idGrade)
        comm.Parameters.Add("@e_qtde", qtde)
    ...
    Public Sub atualizaQtdeGradeSubtraindoId(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                          ByVal qtde As Double, ByVal idGrade As Integer)
    ...
    Public Function existeGradeInclusao(ByVal conexao As NpgsqlConnection, ByVal objGrade As Cl_Grade) As Boolean

        Dim mexiste As Boolean = False
        Dim comm As New NpgsqlCommand
        Dim dr As NpgsqlDataReader
        Dim sqlcmd As String = "SELECT e_codig FROM " & MdlEmpresaUsu._esqVinc & ".estgrade " & _
        "WHERE e_codig = @e_codig AND e_tm = @e_tm AND e_cor = @e_cor AND e_loja = @e_loja"
    ...
    Public Function existeGradeAlteracao(ByVal conexao As NpgsqlConnection, ByVal objGrade As Cl_Grade) As Boolean

        Dim mexiste As Boolean = False
        Dim comm As New NpgsqlCommand
        Dim dr As NpgsqlDataReader
        Dim sqlcmd As String = "SELECT e_codig FROM " & MdlEmpresaUsu._esqVinc & ".estgrade " & _
        "WHERE e_codig = @e_codig AND e_tm = @e_tm AND e_cor = @e_cor AND e_loja = @e_loja AND e_idgrade <> @e_idgrade"
...
#Region "* *  Manutenção de Automóvel  * *"

    Public Sub incAutomovel(ByVal objAutomovel As Cl_Automovel, ByVal conexao As NpgsqlConnection, _
                      ByVal transacao As NpgsqlTransaction)
        ...
        sqlbuild.Append("INSERT INTO cadautomovel(")
        sqlbuild.Append("aut_id, aut_placa, aut_descricao, aut_fornecedor)")
        sqlbuild.Append("VALUES (DEFAULT, @aut_placa, @aut_descricao, @aut_fornecedor); ")

        comm.Transaction = transacao
        comm = New NpgsqlCommand(sqlbuild.ToString, conexao)
        ' Prepara Paramentros
        comm.Parameters.Add("@aut_placa", objAutomovel.pPlaca) : comm.Parameters.Add("@aut_fornecedor", objAutomovel.pCodPart)
        comm.Parameters.Add("@aut_descricao", objAutomovel.pDescricao)
    ...
    Public Sub altAutomovel(ByVal mId As Int32, ByVal objAutomovel As Cl_Automovel, ByVal conexao As NpgsqlConnection, _
                      ByVal transacao As NpgsqlTransaction)
        ...
        sqlbuild.Append("UPDATE cadautomovel ")
        sqlbuild.Append("SET aut_placa = @aut_placa, aut_descricao = @aut_descricao, ")
        sqlbuild.Append("aut_fornecedor = @aut_fornecedor ")
        sqlbuild.Append("WHERE aut_id = @aut_id")

        comm.Transaction = transacao
        comm = New NpgsqlCommand(sqlbuild.ToString, conexao)
        ' Prepara Paramentros
        comm.Parameters.Add("@aut_id", mId)
        comm.Parameters.Add("@aut_placa", objAutomovel.pPlaca) : comm.Parameters.Add("@aut_fornecedor", objAutomovel.pCodPart)
        comm.Parameters.Add("@aut_descricao", objAutomovel.pDescricao)
...
#Region "  * * Manutenção das Condições de Pagamento * *  "

    Public Sub incCondPagto(ByVal condPagto As Cl_CondPagto, ByVal conexao As NpgsqlConnection, _
                            ByVal transacao As NpgsqlTransaction)
        ...
        sqlbuild.Append("INSERT INTO condpagto(")
        sqlbuild.Append("cpg_id, cpg_descricao, cpg_cond1, cpg_cond2, cpg_cond3, cpg_cond4, cpg_cond5, ")
        sqlbuild.Append("cpg_cond6, cpg_cond7, cpg_colpreco, cpg_colrotas, cpg_qtdeparcelas, cpg_intervaloparcelas, ")
        sqlbuild.Append("cpg_acrescimo, cpg_tipo) VALUES (DEFAULT, @cpg_descricao, @cpg_cond1, @cpg_cond2, ")
        sqlbuild.Append("@cpg_cond3, @cpg_cond4, @cpg_cond5, @cpg_cond6, @cpg_cond7, @cpg_colpreco, @cpg_colrotas, ")
        sqlbuild.Append("@cpg_qtdeparcelas, @cpg_intervaloparcelas, @cpg_acrescimo, @cpg_tipo);")

        comm.Transaction = transacao
        comm = New NpgsqlCommand(sqlbuild.ToString, conexao)
        ' Prepara Paramentros
        comm.Parameters.Add("@cpg_descricao", condPagto.pDescricao)
        comm.Parameters.Add("@cpg_cond1", condPagto.pCond1)
        comm.Parameters.Add("@cpg_cond2", condPagto.pCond2)
        comm.Parameters.Add("@cpg_cond3", condPagto.pCond3)
        comm.Parameters.Add("@cpg_cond4", condPagto.pCond4)
        comm.Parameters.Add("@cpg_cond5", condPagto.pCond5)
        comm.Parameters.Add("@cpg_cond6", condPagto.pCond6)
        comm.Parameters.Add("@cpg_cond7", condPagto.pCond7)
        comm.Parameters.Add("@cpg_colpreco", condPagto.pColpreco)
        comm.Parameters.Add("@cpg_colrotas", condPagto.pColrotas)
        comm.Parameters.Add("@cpg_qtdeparcelas", condPagto.pQtdeparcelas)
        comm.Parameters.Add("@cpg_intervaloparcelas", condPagto.pIntervaloparcelas)
        comm.Parameters.Add("@cpg_acrescimo", condPagto.pAcrescimo)
        comm.Parameters.Add("@cpg_tipo", condPagto.pTipo)
    ...
    Public Sub altCondPagto(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                          ByVal id As Int32, ByVal condPagto As Cl_CondPagto)

        Dim comm As New NpgsqlCommand
        Dim sqlbuild As New StringBuilder


        sqlbuild.Append("UPDATE condpagto SET ")
        sqlbuild.Append("cpg_descricao = @cpg_descricao, cpg_cond1 = @cpg_cond1, cpg_cond2 = @cpg_cond2, ")
        sqlbuild.Append("cpg_cond3 = @cpg_cond3, cpg_cond4 = @cpg_cond4, cpg_cond5 = @cpg_cond5, ")
        sqlbuild.Append("cpg_cond6 = @cpg_cond6, cpg_cond7 = @cpg_cond7, cpg_colpreco = @cpg_colpreco, ")
        sqlbuild.Append("cpg_colrotas = @cpg_colrotas, cpg_qtdeparcelas = @cpg_qtdeparcelas, cpg_intervaloparcelas = ")
        sqlbuild.Append("@cpg_intervaloparcelas, cpg_acrescimo = @cpg_acrescimo, cpg_tipo = @cpg_tipo ")
        sqlbuild.Append("WHERE cpg_id = @cpg_id")

        comm.Transaction = transacao
        comm = New NpgsqlCommand(sqlbuild.ToString, conexao)
        ' Prepara Paramentros
        comm.Parameters.Add("@cpg_id", id)
        comm.Parameters.Add("@cpg_descricao", condPagto.pDescricao)
        comm.Parameters.Add("@cpg_cond1", condPagto.pCond1)
        comm.Parameters.Add("@cpg_cond2", condPagto.pCond2)
        comm.Parameters.Add("@cpg_cond3", condPagto.pCond3)
    ...
    Public Sub delCondPagto(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
                          ByVal id As Int32)
        ...
        sqlbuild.Append("DELETE FROM condpagto WHERE cpg_id = @cpg_id")
    ...
    Public Function existeCondpagto(ByVal conexao As NpgsqlConnection, ByVal descricao As String) As Boolean

        Dim mexiste As Boolean = False
        Dim comm As New NpgsqlCommand
        Dim dr As NpgsqlDataReader
        Dim sqlcmd As String = "SELECT cpg_id FROM condpagto WHERE cpg_descricao = @cpg_descricao;"

        comm = New NpgsqlCommand(sqlcmd, conexao)
        comm.Parameters.Add("@cpg_descricao", descricao)
    ...
    Public Function existeCondpagto2(ByVal conexao As NpgsqlConnection, ByVal descricaoAtual As String, _
                                     ByVal descricaoAnterior As String) As Boolean

        Dim mexiste As Boolean = False
        Dim comm As New NpgsqlCommand
        Dim dr As NpgsqlDataReader
        Dim sqlcmd As String = "SELECT cpg_id FROM condpagto WHERE cpg_descricao <> @cpg_descranterior AND " & _
        "cpg_descricao = @cpg_descratual;"

        comm = New NpgsqlCommand(sqlcmd, conexao)
        comm.Parameters.Add("@cpg_descratual", descricaoAtual)
        comm.Parameters.Add("@cpg_descranterior", descricaoAnterior)
...
#Region "* *  Manutenção de Movimento de Comodatos  * *"
    ...
    Public Sub incMovComodato(ByVal mCodPart As String, ByVal mCodProd As Int32, ByVal mnomeProd As String, _
        ...
        comm.Parameters.Add("@mc_produto", mnomeProd) : comm.Parameters.Add("@mc_dtemprestimo", mDtEmprestimo)
        comm.Parameters.Add("@mc_dtdevolucao", mDtDevolucao) : comm.Parameters.Add("@mc_motorista", mMotorista)
    ...
    Public Function existeMovComodato(ByVal mIdMovComod As Int32, ByVal mIdCodpr As Int32, _
        ...
        dr.Close() : conexao.ClearPool() : comm = Nothing : sqlbuild = Nothing : dr = Nothing
...
#Region " * *  Manutenção de Participante  CADP001 * * "
    ...
    Public Sub inclueParticipante(ByVal clCadp001 As Cl_Cadp001, ByVal conexao As NpgsqlConnection, _
        ...
        sqlbuild.Append("p_sexo, p_celular, p_inativo, p_usuario, p_isento) VALUES (")
        sqlbuild.Append("@p_tipo, @p_carac, @p_dtcad, @p_cod, @p_portad, @p_fantas, @p_civil, ")
        sqlbuild.Append("@p_dtnativ, @p_natur, @p_ident, @p_cpf, @p_cgc, @p_insc, @p_pai, @p_mae, ")
        sqlbuild.Append("@p_end, @p_bairro, @p_cid, @p_uf, @p_cep, @p_fone, @p_ltrab, @p_endtr, ")
        sqlbuild.Append("@p_fontr, @p_cargo, @p_salar, @p_esposo, @p_crt, @p_ltrabe, @p_salae, ")
        ...
        sqlbuild.Append("@p_pedido, @p_cdvend, @p_cdcid, @p_bloq, @p_tb, @p_consumo, @p_mun, ")
        sqlbuild.Append("@p_coduf, @p_ctactb, @p_ctaanli, @p_mes, @p_fax, @p_prep, @p_email, ")
        sqlbuild.Append("@p_sexo, @p_celular, @p_inativo, @p_usuario, @p_isento);")
        ...
        Try
            comm.Parameters.Add("@p_dtcad", CDate(clCadp001.pDtcad))
        Catch ex As Exception
            comm.Parameters.Add("@p_dtcad", System.DBNull.Value)
        End Try
        ...
        Try
            comm.Parameters.Add("@p_dtnativ", CDate(clCadp001.pDtnativ))
        Catch ex As Exception
            comm.Parameters.Add("@p_dtnativ", System.DBNull.Value)
        End Try
        ...
        Try
            comm.Parameters.Add("@p_ultcomp", Convert.ToDateTime(clCadp001.pUltcomp))
        Catch ex As Exception
            comm.Parameters.Add("@p_ultcomp", System.DBNull.Value)
        End Try
    ...
    Public Sub altParticipante(ByVal clCadp001 As Cl_Cadp001, ByVal codAtual As String, _
        ...
        sqlbuild.Append("p_inativo = @p_inativo, p_isento = @p_isento ")
        sqlbuild.Append("WHERE p_cod = '" & codAtual & "'")
...
#Region "   * * Manutenção de Roteiro * *   "
    ...
    Public Sub incRoteiroMapa(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
        ...
        comm.Parameters.Add("@rt_ateracao", dtalteracao)
...
#Region "  * * Manutenção da tabela de preços * *  "
    ...
    Public Function trazColunaTblPreco(ByVal descrCondicao As String, ByVal conexao As NpgsqlConnection) As Int32
        ...
        Dim dr As NpgsqlDataReader
        Dim comm As New NpgsqlCommand
        Dim sqlcmd As String = "SELECT cpg_colrotas FROM condpagto WHERE cpg_descricao = '" & descrCondicao & "'"
...
#Region "* * *  Manutenção CadRegistro  * * *"
    ...
    Public Function trazProxCodForn(ByVal conexao As NpgsqlConnection) As Int32
        ...
        drForn.Close() : drForn = Nothing : comm = Nothing : sqlcmd = Nothing : conexao.ClearPool()
        If mCodForn = 0 Then mCodForn = 1
    ...
    Public Function trazProxCodProd(ByVal conexao As NpgsqlConnection) As Int32
        ...
        drProd.Close() : drProd = Nothing : comm = Nothing : sqlcmd = Nothing : conexao.ClearPool()
    ...
    Public Function trazProxCodVendedor(ByVal conexao As NpgsqlConnection) As Int32
        ...
        drVendedor.Close() : drVendedor = Nothing : comm = Nothing : sqlcmd = Nothing : conexao.ClearPool()
    ...
    Public Function trazProxCodRequis(ByVal geno As String, ByVal conexao As NpgsqlConnection) As Int32
        ...
        drRequis.Close() : drRequis = Nothing : comm = Nothing : sqlcmd = Nothing : conexao.ClearPool()
    ...
    Public Function trazProxCodMapa(ByVal geno As String, ByVal conexao As NpgsqlConnection) As Int32
        ...
        drMp.Close() : drMp = Nothing : comm = Nothing : sqlcmd = Nothing : conexao.ClearPool()
        If mCodRequis = 0 Then mCodRequis = 1
    ...
    Public Function trazProxMapaPedido(ByVal geno As String, ByVal conexao As NpgsqlConnection) As Int32
        ...
        dr.Close() : dr = Nothing : comm = Nothing : sqlcmd = Nothing : conexao.ClearPool()
...
#Region "*  *  *   Manutenção Orcamento   *  *  *"
    ...
    Public Sub incOrcamento_Orca1(ByVal nt_id As Int64, ByVal orca As String, ByVal geno As String, ByVal codigo As String, ByVal dtemis As Date, ByVal dtsai As Date, ByVal TPemiss As Boolean, ByVal cfop As String, _
        ...
        comm.Parameters.Add("@nt_codig", codigo) : comm.Parameters.Add("@nt_dtemis", dtemis)
        comm.Parameters.Add("@nt_dtsai", dtsai) : comm.Parameters.Add("@nt_emiss", TPemiss)
    ...
    Public Sub incOrcamento_Orca2(ByVal geno As String, ByVal orca As String, ByVal codpr As String, ByVal und As String, ByVal qtde As Double, ByVal PcoVenda As Double, _
        ...
        comm.Parameters.Add("@no_dtemis", dtemis)
...
#Region "  * *  Manutenção de Movimentos de Telecomunicações, Energia e Entradas de Terceiros * * *  "
    ...
    Public Sub IncServComunicacao(ByVal numero As String, ByVal serie As String, ByVal subserie As String, ByVal emissao As Date, _
        ...
        Try
            ...
            comm.Parameters.Add("@fn_emissao", emissao)
            comm.Parameters.Add("@fn_dtentrada", dtentrada)
            comm.Parameters.Add("@fn_cdport", cdport)
            comm.Parameters.Add("@fn_fone", fone)
            comm.Parameters.Add("@fn_mesano", mesano)
            comm.Parameters.Add("@fn_vencto", vencto)
    ...
    Public Sub IncServErnegia(ByVal numero As String, ByVal serie As String, ByVal subserie As String, ByVal emissao As Date, ByVal dtentrada As Date, _
        ...
        Try
            ...
            comm.Parameters.Add("@en_emissao", emissao)
            comm.Parameters.Add("@en_dtentrada", dtentrada)
            comm.Parameters.Add("@en_mesano", mesano)
            comm.Parameters.Add("@en_vencto", vencto)
    ...
    Public Sub IncNfEntradaTerc(ByVal numero As String, ByVal fornecedor As String, ByVal Estabelecimento As String, ByVal serie As String, _
        ...
        comm.Parameters.Add("@n4_dtemis", dtEmissao)
        comm.Parameters.Add("@n4_dtent", dtentrada)
    ...
    Public Sub incItensNfEntradasTerc(ByVal mIdN4ff As Integer, ByVal mNumeroNF As String, ByVal mCodForn As String, ByVal mCodProd As String, ByVal mNomeProd As String, _
        ...
        comm.Parameters.Add("@nc_data", mDtEntProd)
        comm.Parameters.Add("@nc_dtusu", mDtUsuProd)
    ...
    Public Sub IncContas_a_Pagar(ByVal idN4FF As Int64, ByVal Estabelecimento As String, ByVal fornecedor As String, ByVal tipoBL As String, _
        ...
        comm.Parameters.Add("@d_emiss", dtEmissao)
        comm.Parameters.Add("@d_vencto", dtVecimento)
...
#Region " * * *  Manutenção em Cadastro de Produtos * * *  "
    ...
    Public Sub incProduto(ByVal Produto As Cl_Est0001, ByVal conexao As NpgsqlConnection, _
        ...
        Try
            comm.Parameters.Add("@e_dtcomp", CDate(Produto.pDtcomp))
        Catch ex As Exception
            comm.Parameters.Add("@e_dtcomp", System.DBNull.Value)
        End Try
        ...
        Try
            comm.Parameters.Add("@e_dtvend", CDate(Produto.pDtvend))
        Catch ex As Exception
            comm.Parameters.Add("@e_dtvend", System.DBNull.Value)
        End Try
        ...
        Try
            comm.Parameters.Add("@e_valid", CDate(Produto.pValid))
        Catch ex As Exception
            comm.Parameters.Add("@e_valid", System.DBNull.Value)
        End Try
        ...
        Try
            comm.Parameters.Add("@e_dtinicialpromocao", CDate(Produto.pDtinicialpromocao))
        Catch ex As Exception
            comm.Parameters.Add("@e_dtinicialpromocao", System.DBNull.Value)
        End Try

        Try
            comm.Parameters.Add("@e_dtfinalpromocao", CDate(Produto.pDtfinalpromocao))
        Catch ex As Exception
            comm.Parameters.Add("@e_dtfinalpromocao", System.DBNull.Value)
        End Try

        Try
            comm.Parameters.Add("@e_dtinicialbonific", CDate(Produto.pDtinicialbonific))
        Catch ex As Exception
            comm.Parameters.Add("@e_dtinicialbonific", System.DBNull.Value)
        End Try

        Try
            comm.Parameters.Add("@e_dtfinalbonific", CDate(Produto.pDtfinalbonific))
        Catch ex As Exception
            comm.Parameters.Add("@e_dtfinalbonific", System.DBNull.Value)
        End Try
    ...
    Public Sub altProduto(ByVal Produto As Cl_Est0001, ByVal conexao As NpgsqlConnection, _
        ...
        comm.Parameters.Add("@e_inventa", Produto.pInventa) : comm.Parameters.Add("@e_pcustom", Produto.pPcustom)
        comm.Parameters.Add("@e_pcustoa", Produto.pPcustoa) : comm.Parameters.Add("@e_prepo", Produto.pPrepo)
        comm.Parameters.Add("@e_pcomp", Produto.pPcomp) 'comm.Parameters.Add("@e_dtcomp", CDate(dtcomp))
    ...
    Public Sub importProd(ByVal Codigo As Integer, ByVal CodBarra As String, ByVal CodNcm As String, ByVal Produto As String, _
        ...
        Try
            ...
            comm.Parameters.Add("@p_dtaltera", Convert.ToDateTime(DTAlterada))
            ...
            comm.Parameters.Add("@p_dtcomp", Convert.ToDateTime(DtComp))
            comm.Parameters.Add("@p_dtvend", Convert.ToDateTime(DtVenda))
...
#Region " * *  Manutenção em Duplicatas Contas a Pagar * *  "
    ...
    Public Sub incPagamentoFatp001(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
        ...
        Try
            ...
            sqlbuild.Append("d_banco, d_hist, d_sit, d_outros) ")
            ...
            sqlbuild.Append("@d_desc, @d_banco, @d_hist, @d_sit, @d_outros) ")
            ...
            comm.Parameters.Add("@d_emiss", DtEmissao)
            comm.Parameters.Add("@d_vencto", DtVencto)
            comm.Parameters.Add("@d_valor", Valor)

            Try
                comm.Parameters.Add("@d_dtpaga", CDate(DtPaga))
            Catch ex As Exception
                comm.Parameters.Add("@d_dtpaga", System.DBNull.Value)
            End Try
    ...
    Public Sub incDuplicatas(ByVal Codigo As Integer, ByVal CodForn As Integer, ByVal Fatura As String, ByVal Documento As String, _
        ...
        Try
            ...
            comm.Parameters.Add("@p_emissao", DtEmissao)
            comm.Parameters.Add("@p_vencto", DtVencto)
            comm.Parameters.Add("@p_valor", Valor)
            comm.Parameters.Add("@p_dtpaga", DtPaga)
...
#Region " * *  Manutenção em Duplicatas contas a Receber * *  "
    ...
    Public Sub incDuplicatasR(ByVal Geno As String, ByVal CodCli As String, ByVal tipo As String, ByVal Fatura As String, _
                ...
                ByVal desconto As Double, ByVal Banco As Integer, ByVal Historico As String, ByVal hvencto As String, ByVal Protesto As Double, _
                ByVal outros As Double, ByVal Instr1 As String, ByVal Instr2 As String, ByVal Instr3 As String, ByVal Situacao As String, _
                ByVal status As Boolean, ByVal Loja As String, ByVal ftidx As Integer, ByVal Contactb As String, ByVal Contared As String, _
                ByVal NNumero As String, ByVal Impressao As String, ByVal Transmissao As String, ByVal Conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction)

        Try
            Dim comm As NpgsqlCommand
            Dim sqlbuild As New StringBuilder

            sqlbuild.Append("INSERT INTO " & MdlEmpresaUsu._esqEstab & ".fatd001(f_geno, f_portad, f_tipo, f_nfat, f_nfisc, f_serie, f_txdesc, ")
            sqlbuild.Append("f_duplic, f_emiss, f_vencto, f_valor, f_cartei,  f_juros, f_desc, f_banco, ")
            sqlbuild.Append("f_hist, f_hvenc, f_protest, f_outros, f_codi1,f_codi2, f_codi3, f_sit, f_stat, f_loja, ")
            sqlbuild.Append("f_ftidx, f_ctactb, f_ctareduz,f_nnumero, f_imp, f_mtransm) VALUES (@f_geno, @f_portad, @f_tipo,@f_nfat, @f_nfisc, ")
            sqlbuild.Append("@f_serie, @f_txdesc, @f_duplic, @f_emiss, @f_vencto, @f_valor,@f_cartei, ")
            sqlbuild.Append("@f_juros,@f_desc, @f_banco, @f_hist, @f_hvenc, @f_protest, @f_outros, @f_codi1, ")
            sqlbuild.Append("@f_codi2, @f_codi3, @f_sit, @f_stat, @f_loja, default, @f_ctactb, @f_ctareduz,@f_nnumero, @f_imp, @f_mtransm)")
            ...
            comm.Parameters.Add("@f_txdesc", txdesc)
            comm.Parameters.Add("@f_duplic", Documento)
            comm.Parameters.Add("@f_emiss", Emissao)
            comm.Parameters.Add("@f_vencto", Vencto)
            comm.Parameters.Add("@f_valor", Valor)
    ...
    Public Sub altDuplicatasR(ByVal Codigo As Integer, ByVal CodCli As Integer, ByVal Fatura As String, ByVal Documento As String, _
        ...
        Try
            ...
            comm.Parameters.Add("@r_emissao", DtEmissao)
            comm.Parameters.Add("@r_vencto", DtVencto)
            comm.Parameters.Add("@r_valor", Valor)
            comm.Parameters.Add("@r_dtpaga", DtPaga)
    ...
    Public Sub IncPagamentos_Parciais(ByVal geno As String, ByVal portador As String, ByVal tipo As String, ByVal nfatura As String, _
        ...
        Try
            ...
            comm.Parameters.Add("@d_duplic", Documento)
            comm.Parameters.Add("@d_emiss", emissao)
            comm.Parameters.Add("@d_vencto", vencto)
            comm.Parameters.Add("@d_valor", valor)
            comm.Parameters.Add("@d_cartei", carteira)
            comm.Parameters.Add("@d_dtpaga", dtpaga)
            comm.Parameters.Add("@d_juros", juros)
...
#Region "***  Manutenção da NFe Entrada (Nota4ff, Nota2ff)  ***"
    ...
    Public Sub incNota2ff(ByVal nota2ff As Cl_Nota2ff, ByVal geno001 As Cl_Geno, _
        ...
        Try
            comm.Parameters.Add("@nc_data", nota2ff.nc_data)
        Catch ex As Exception
            comm.Parameters.Add("@nc_data", System.DBNull.Value)
        End Try

        Try
            comm.Parameters.Add("@nc_dtusu", nota2ff.nc_dtusu)
        Catch ex As Exception
            comm.Parameters.Add("@nc_dtusu", System.DBNull.Value)
        End Try
...
#Region "* *  *   Manutenção da NFe (Nota1pp, Nota2cc, Nota4dd)   *  * *"
    ...
    Public Sub incNota1pp(ByVal nota1pp As Cl_Nota1pp, ByVal conexao As NpgsqlConnection, _
        ...
        sqlbuild.Append("nt_status, nt_xml, nt_orca) VALUES (@tipo_nt, @nt_tipo, ")
        ...
        sqlbuild.Append("@nt_x, @nt_y, @nt_lote, @nt_chave, @nt_hrweb, @nt_webrec, @nt_proto, ")
        sqlbuild.Append("@nt_status, @nt_xml, @nt_orca)")
        ...
        Try
            comm.Parameters.Add("@nt_dtemis", CDate(nota1pp.pNt_dtemis))
        Catch ex As Exception
            comm.Parameters.Add("@nt_dtemis", System.DBNull.Value)
        End Try
        Try
            comm.Parameters.Add("@nt_dtsai", CDate(nota1pp.pNt_dtsai))
        Catch ex As Exception
            comm.Parameters.Add("@nt_dtsai", System.DBNull.Value)
        End Try
    ...
    Public Sub incNota2cc(ByVal nota2cc As Cl_Nota2cc, ByVal conexao As NpgsqlConnection, _
        ...
        Try
            comm.Parameters.Add("@nc_dtemis", nota2cc.pNc_dtemis)
        Catch ex As Exception
            comm.Parameters.Add("@nc_dtemis", System.DBNull.Value)
        End Try
    ...
    Public Sub incNota4dd(ByVal nota4dd As Cl_Nota4dd, ByVal conexao As NpgsqlConnection, _
        ...
        sqlbuild.Append("n4_desc, n4_vlpis, n4_vlcofins, n4_idn1pp, n4_peso, n4_totalimp, n4_totaltrib) ")
...
#Region "  * * Manutenção do CUPOM FISCAL Cup... * *  "
    ...
    Public Sub incPedidoCup1ppx(ByVal cp_orca As String, ByVal cp_geno As String, ByVal cp_codig As String, _
        ...
        comm.Parameters.Add("@cp_codig", cp_codig) : comm.Parameters.Add("@cp_dtemis", cp_dtemis)
        comm.Parameters.Add("@cp_dtsai", cp_dtsai) : comm.Parameters.Add("@cp_cfop", cp_cfop)
    ...
    Public Sub incPedidoCup2ccx(ByVal no_orca As String, ByVal no_codpr As String, ByVal no_produt As String, _
        ...
        comm.Parameters.Add("@no_dtemis", no_dtemis)
    ...
    Public Sub incCup5zz(ByVal cz_tipo As String, ByVal cz_subtipo As String, _
        ...
        comm.Parameters.Add("@cz_dtemis", cz_dtemis) : comm.Parameters.Add("@cz_nserie", cz_nserie)
...
#Region "  *  *  *   Movimento de Pedidos de Venda (Orca1,Orca2,Orca4)  *  *   * "
    ...
    Public Sub updateMapaOrca1pp(ByVal numpedido As String, ByVal numMapa As String, _
        ...
        transacao.Commit() : oConnBDMETROSYS.ClearPool() : oConnBDMETROSYS.Close() : oConnBDMETROSYS = Nothing
        transacao = Nothing
    End Sub
...
#Region "  *  *  *  Entrada de Mercadorias   *  *  *   "
    ...
    Public Sub Reg_EntradaSimples(ByVal id As Integer, ByVal Codforne As String, ByVal Numero As String, ByVal DTemissao As Date, _
        ...
        Try
            ...
            comm.Parameters.Add("n4_numer", Numero)
            comm.Parameters.Add("n4_dtemis", DTemissao)
            comm.Parameters.Add("n4_dtentrada", DTentrada)
...
#Region "  *  *   Controle Estoque   *  *   "
    ...
    Public Sub somaQtdeProd_entradaSimples(ByVal CodForn As String, ByVal codproduto As String, ByVal codloja As String, ByVal novaqtde As Double, _
        ...
        comm.Parameters.Add("@e_dtcomp", DtCompra)
