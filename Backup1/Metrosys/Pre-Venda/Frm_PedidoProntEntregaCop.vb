...
Public Class Frm_PedidoProntEntregaCop
    ...
    Public Shared _frmREf As New Frm_PedidoProntEntregaCop
    ...
    Private Sub Frm_PedidoProntEntregaCop_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

        If (e.KeyCode = Keys.Escape) Then Me.Close()
    End Sub

    Private Sub Frm_PedidoProntEntregaCop_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub Frm_PedidoProntEntregaCop_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Numero do pedido...
        txt_pedido.Text = String.Format("{0:D8}", Convert.ToInt64(_clBD.trazProxNumPedido(conexao))) '_clBD.trazProxNumPedido(MdlEmpresaUsu._codigo, conexao)
    ...
    Private Sub alteraRegistroPedido(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction)
        ...
        nt_sit = 1
        nt_entrada = CDbl(txt_entrada.Text)
    ...
    Private Sub preenchCamposRegistroPedido(ByVal numPedido As String)
        ...
        Try
            ...
            sqlPedido.Append("nt_cod6, nt_cod7, nt_mapa, nt_sit, nt_idx, nt_entrada, nt_descrcondpagto ") '30 'cad.p_portad, cad.p_consumo 
            sqlPedido.Append("FROM " & MdlEmpresaUsu._esqEstab & ".orca1pp LEFT JOIN cadp001 cad ON ")
            ...
            While drPedido.Read
                ...
                Me.txt_entrada.Text = Format(drPedido(29), "###,##0.00")
                condicao = drPedido(30).ToString
    ...
    Private Sub Frm_PedidoProntEntregaCop_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
