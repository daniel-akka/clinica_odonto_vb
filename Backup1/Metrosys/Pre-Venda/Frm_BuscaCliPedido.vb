...
Public Class Frm_BuscaCliPedido
    ...
    Private Sub setValoresFormRef()
        ...
        _formRequest._frmREf.mbUf = Me.Dg_particpante.CurrentRow.Cells(5).Value.ToString
        _formRequest._frmREf.mbCNPJ = Me.Dg_particpante.CurrentRow.Cells(2).Value.ToString
        _formRequest._frmREf.mbCPF = Me.Dg_particpante.CurrentRow.Cells(3).Value.ToString
        ...
        _formRequest._frmREf.mEnderecoPart = Me.Dg_particpante.CurrentRow.Cells(7).Value.ToString
        _formRequest._frmREf.mCepPart = Me.Dg_particpante.CurrentRow.Cells(8).Value.ToString
        _formRequest._frmREf.mFonePart = Me.Dg_particpante.CurrentRow.Cells(9).Value.ToString
        _formRequest._frmREf.mConsumo = Me.Dg_particpante.CurrentRow.Cells(10).Value.ToString
        _formRequest._frmREf.mIsento = Me.Dg_particpante.CurrentRow.Cells(11).Value.ToString
    ...
    Private Sub preencheDgrd_Participante(ByVal ultimChar As String)
        ...
        If oConnBDGENOV.State = ConnectionState.Open Then
            Dim codigo, nome, cnpj, cpf, inscricao, UF, endereco, cidade, cep, fone, consumo As String
            Dim isento As Boolean

            Try
                SqlParticipante.Append("SELECT p_cod, p_portad, p_cgc, p_cpf, p_insc, p_uf, p_end, p_cid, ") ' 7
                SqlParticipante.Append("p_cep, p_fone, p_consumo, p_isento FROM cadp001 WHERE p_inativo = FALSE ") ' 11
                ...
                While drParticipante.Read
                    ...
                    cnpj = drParticipante(2).ToString
                    ...
                    consumo = drParticipante(10).ToString
                    isento = drParticipante(11)

                    Dg_particpante.Rows.Add(codigo, nome, cnpj, cpf, inscricao, UF, cidade, endereco, _
                                            cep, fone, consumo, isento)

                End While

                drParticipante.Close() : oConnBDGENOV.ClearPool()
                ds.Clear() : Me.lbl_registros.Text = Me.Dg_particpante.Rows.Count
                Me._erro = False
            Catch ex As Exception
                Me._erro = True
