...
Public Class Frm_PedidoProntEntrega
    ...
    Dim mNumPedido As String = "", mNumPedidoTemp As String = ""
    ...
    Public Shared _frmREf As New Frm_PedidoProntEntrega
    ...
    Dim _documentoImpresso As Boolean = False
    ...
    Private Sub Frm_PedidoProtaEntrega_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub Frm_PedidoProtaEntrega_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

        If (e.KeyCode = Keys.Escape) Then Me.Close()
    End Sub

    Private Sub Frm_PedidoProtaEntrega_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub Frm_PedidoProtaEntrega_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub limpaCamposRegistroProd()
        ...
        Me.msk_senha.Text = "" 'Me.msk_senha.Enabled = False
    ...
    Private Sub incluiDtg_itens(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction)
        ...
        mrota = 0
        If cbo_rota.SelectedIndex >= _valorZERO Then mrota = CInt(cbo_rota.SelectedItem)
    ...
    Private Sub incluiDtg_itensPedidoTemporaria(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction)
        ...
        mrota = 0
        If cbo_rota.SelectedIndex >= _valorZERO Then mrota = CInt(Trim(Mid(cbo_rota.SelectedItem, 1, 2)))

        _clBD.delPedido_Orca2Temporaria(mNumPedidoTemp, cbo_local.SelectedItem, conexao, transacao)
        ...
        For Each row As DataGridViewRow In Me.dtg_pedidoprotaentrega.Rows
            ...
            If Not row.IsNewRow Then
                ...
                _clBD.incPedido_Orca2Temporaria(Mid(cbo_local.SelectedItem, 1, 2), mNumPedidoTemp, mCodpr, MUnd, mQtde, mPrvenda, malqdesc, _
                                       mvldesc, mPrunit, mtotal, malqicms, mbaseIcms, mbasesub, malqsub, mvlsub, _
                                       mdtemis, mrota, "01", mCodVendedor, mLinha, mGrupo, malqcom, mcomis, _valorZERO, _
    ...
    Private Sub txt_pedido_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_pedido.TextChanged

        If Me.txt_pedido.Text.Equals("") Then Me._numPedidoOK = False
    ...
    Private Sub PrintPreviewDialog1_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles PrintPreviewDialog1.FormClosed
        _documentoImpresso = False
    End Sub

    Private Sub PrintPreviewDialog1_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintPreviewDialog1.Shown
        _documentoImpresso = False
    End Sub
