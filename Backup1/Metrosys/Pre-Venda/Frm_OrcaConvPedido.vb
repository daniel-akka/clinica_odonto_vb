...
Public Class Frm_OrcaConvPedido
    ...
    Public Shared _frmREf As New Frm_OrcaConvPedido
    ...
    Private Sub Frm_OrcamentoCop_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cbo_vendedor.SelectedIndex = _clFuncoes.trazIndexCboVendedor(MdlUsuarioLogando._codvendedor, cbo_vendedor)
    ...
    Private Sub addItemEditadoGrid()
        ...
        Try
            ...
            Dim mvlsub, malqdesc, mvldesc, mbaseicms, moutrasdesp, mvlUnitItem As Double
    ...
    Private Sub btn_incluir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_incluir.Click
        ...
        If verificaProduto() Then
            ...
            If _codProdEditando.Equals("") Then ' Se for só Inclusão

                If colunaDuplicada(Me.txt_codProd.Text) = False Then

                    addItemGrid()

                    If _numPedidoOK = False Then 'Verifica se já foi pego o numero do pedido e se já tá na tabela temporária
                        ...
                        'Numero do pedido...
                        txt_pedido.Text = String.Format("{0:D8}", Convert.ToInt64(_clBD.trazProxNumPedido(conexao)))
                        mNumPedido = txt_pedido.Text : mNumPedidoTemp = txt_pedido.Text
                        'mProxNumPedido = CInt(txt_pedido.Text) + 1
                        '_clBD.updateGenp001NumPedido(MdlEmpresaUsu._codigo, String.Format("{0:D8}", mProxNumPedido), conexao, transacao)
                        transacao.Commit() : conexao.ClearAllPools() : conexao.Close() : conexao = Nothing
                        _numPedidoOK = True
    ...
    Private Sub alteraRegistroPedido(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction)
        ...
        _clBD.altPedido_Orca1(nt_orca, nt_geno, nt_codig, nt_dtemis, nt_dtsai, nt_emiss, nt_cfop, _
                              nt_vend, nt_cid, nt_itens, nt_rota, nt_peso, nt_x, nt_y, nt_parc, _
                              nt_volum, nt_tipo2, nt_auto, nt_auto2, nt_cod1, nt_cod2, nt_cod3, _
                              nt_cod4, nt_cod5, nt_cod6, nt_cod7, nt_mapa, nt_sit, mbUf, nt_entrada, _
                              nt_descrcondpagto, conexao, transacao)
    ...
    Private Sub preenchItensPedido(ByVal numPedido As String)
        ...
        Try
            ...
            While drPedido.Read
                ...
                'Tratamento da Grade...
                objGrade.zeraValores()
                If grade.Equals("S") Then
                    objGrade.pCodig = drPedido(1).ToString
                    objGrade.pCor = drPedido(26).ToString
                    objGrade.pTm = drPedido(27).ToString
                    objGrade.pLoja = drPedido(20).ToString
                    objGrade.pQtde = drPedido(5)
                End If
                ...
                If mqtde > 0 Then
                    ...
                    If drPedido(5) <= mqtde Then 'Se a quantidade do pedido for <= que a quantidade atual
                        ...
                        _clBD.subtraiQtdeProdEstloja(drPedido(1).ToString, drPedido(20).ToString, drPedido(5), conexao, transacao)
                        If grade.Equals("S") Then _clBD.atualizaQtdeGradeSubtraindo(conexao, transacao, objGrade)
                    ...
                    Else
                        _clBD.subtraiQtdeProdEstloja(drPedido(1).ToString, drPedido(20).ToString, mqtde, conexao, transacao)
                        If grade.Equals("S") Then _clBD.atualizaQtdeGradeSubtraindo(conexao, transacao, objGrade)
                        ...
                        drPedido(8), drPedido(9), drPedido(10), drPedido(11), _
                        drPedido(12), drPedido(13), drPedido(14), drPedido(15), drPedido(16), drPedido(17), _
                        drPedido(18), drPedido(19).ToString, drPedido(20).ToString, drPedido(21), drPedido(22), drPedido(23), _
                        drPedido(24), grade, drPedido(26).ToString, drPedido(27).ToString, drPedido(25)}
