...
Public Class Frm_OrcamentoAlt
    ...
    Private Sub Frm_OrcamentoAlt_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub Frm_OrcamentoAlt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub Frm_OrcamentoAlt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub alteraRegistroOrcamento(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction)
        ...
        'Numero do pedido...
        nt_orca = Me.txt_orcamento.Text : mNumPedido = nt_orca
    ...
    Private Sub txt_orcamento_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_orcamento.TextChanged
    ...
    Private Sub Frm_OrcamentoAlt_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing


        If dtg_pedidoprotaentrega.Rows.Count > 0 Then

            If MessageBox.Show("Deseja Realmente Sair sem Finalizar?", "METROSYS", MessageBoxButtons.YesNo, MessageBoxIcon.Question) _
