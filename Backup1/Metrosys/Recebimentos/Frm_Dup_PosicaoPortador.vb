...
Public Class Frm_Dup_PosicaoPortador
    ...
    Private Sub consultaBD(ByVal CodPort As String, ByVal IndiceX As Integer)
        ...
        Try
            ...
            Select Case cbo_tipo.SelectedIndex
                ...
                Case 1 'CH - Cheque
                    sqlPart.Append("AND Ft.f_tipo = 'CH' ")

                Case 2 'BL - Boleto
                    sqlPart.Append("AND Ft.f_tipo = 'BL' ")

                Case 3 'NP - N.Promissoria
                    sqlPart.Append("AND Ft.f_tipo = 'NP' ")

                Case 4 'CR - Carnê
                    sqlPart.Append("AND Ft.f_tipo = 'CR' ")

                Case 5 'CT - Cartão
                    sqlPart.Append("AND Ft.f_tipo = 'CT' ")
