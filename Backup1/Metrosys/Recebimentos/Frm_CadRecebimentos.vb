...
Public Class Frm_CadRecebimentos
    ...
    Private Sub inclueRegistro(ByVal conexao As NpgsqlConnection, ByVal transacao As NpgsqlTransaction, _
        ...
        _clBD.incDuplicatasR(CodGeno, CodForn, Tipo, Fatura, Fatura, "000", 0.0, Documento, DtEmissao, DtVencto, Valor, "00", _
                         DtPaga, Juros, Descontos, Banco, Historico, "", txt_protesto.Text, Outros, "99", "01", "05", Situacao, _
                         False, Mid(MdlEmpresaUsu._codigo, 3, 3), 0, "", "", "", "", "", conexao, transacao)
    End Sub
    ...
    Public Function trazCliente(ByVal codFornec As String) As Boolean
    ...
    Private Sub txt_fatura_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_fatura.KeyPress
    ...
    Private Sub dtp_emissao_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dtp_emissao.Leave
