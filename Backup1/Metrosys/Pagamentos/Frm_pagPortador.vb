...
Public Class Frm_pagPortador

    Private Const _valorZERO As Integer = 0
    Private Mlojas As String
    Public Shared _frmRef As New Frm_pagPortador
    ...
    Private Sub consultaBD(ByVal CodPort As String, ByVal IndiceX As Integer)
        ...
        Try
            ...
            Select Case cbo_tipo.SelectedIndex
                ...
                Case 1 'CH - Cheque
                    sqlPart.Append("AND d_tipo = 'CH' ")

                Case 2 'BL - Boleto
                    sqlPart.Append("AND d_tipo = 'BL' ")

                Case 3 'NP - N.Promissoria
                    sqlPart.Append("AND d_tipo = 'NP' ")

                Case 4 'CR - Carnê
                    sqlPart.Append("AND d_tipo = 'CR' ")

                Case 5 'CT - Cartão
                    sqlPart.Append("AND d_tipo = 'CT' ")
            ...
            If (Me.cbo_opcoes.SelectedIndex = _valorZERO) OrElse (Me.cbo_opcoes.SelectedIndex = 2) Then
        ...
        Me.dtg_posicaoport.Focus() : oConnBDGENOV.ClearPool() : oConnBDGENOV.Close() : oConnBDGENOV = Nothing
    ...
    Private Sub executaF6()
        ...
        If (Me.dtg_posicaoport.Rows.Count > _valorZERO) Then
            ...
            executaRelatorio("", "\wged\consultaPosiPort.txt")
        End If
    ...
    Private Sub executaRelatorio(ByVal unidadePC As String, ByVal arqSaida As String)
        ...
        Dim mArqTemp As String = "\wged\TEMPconsultaPosiPort.TMP"
    ...
    Private Sub gravaDuplicadas(ByVal s As StreamWriter)
        ...
        Try
            ...
            While drPart.Read
                ...
                Try
                    mDtemiss = Format(CDate(drPart(5).ToString), "dd/MM/yyyy")
                Catch ex As Exception
                    mDtemiss = ""
                End Try

                Try
                    mDtVencto = Format(CDate(drPart(6).ToString), "dd/MM/yyyy")
                Catch ex As Exception
                    mDtVencto = ""
                End Try

                Try
                    mDtPagNormal = Format(CDate(drPart(7).ToString), "dd/MM/yyyy")
                Catch ex As Exception
                    mDtPagNormal = ""
                End Try
                ...
                Try
                    ...
                    Try
                        mDtPaga = Format(CDate(drPart(11)), "dd/MM/yyyy")
                    Catch ex As Exception
                        mDtPaga = ""
                    End Try
                Catch ex As Exception
