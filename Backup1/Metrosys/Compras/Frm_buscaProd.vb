    ...
    Private Sub preencheDgrd_Produto(ByVal pesquisa As String)
        ...
        If oConnBDMETROSYS.State = ConnectionState.Open Then
            ...
            Try
                ...
                SqlProduto.Append("el.e_loja = '" & _formRequest._frmREf.cbo_local.Text & "' AND ")
        ...
        Select Case e.KeyCode
            Case Keys.Enter
                ...
                Else
                    ...
                    _formRequest._frmREf.mbUndProd = Me.Dg_produto.CurrentRow.Cells(4).Value.ToString
                    _formRequest._frmREf.txt_ncm.Text = Me.Dg_produto.CurrentRow.Cells(5).Value.ToString
                    _formRequest._frmREf.mCstIten = Me.Dg_produto.CurrentRow.Cells(6).Value.ToString
                    _formRequest._frmREf.mCfvIten = Me.Dg_produto.CurrentRow.Cells(7).Value.ToString
                    _formRequest._frmREf.mGrupoIten = Me.Dg_produto.CurrentRow.Cells(8).Value.ToString
                    _formRequest._frmREf.mReduzIten = Me.Dg_produto.CurrentRow.Cells(9).Value.ToString
                    _formRequest._frmREf.txt_SaldoAtual.Text = Me.Dg_produto.CurrentRow.Cells(10).Value.ToString
                    _formRequest._frmREf.txt_custAnter.Text = Me.Dg_produto.CurrentRow.Cells(11).Value.ToString
                    _formRequest._frmREf.txt_pcoAnt.Text = Me.Dg_produto.CurrentRow.Cells(12).Value.ToString
                    _formRequest._frmREf.mClfIten = Me.Dg_produto.CurrentRow.Cells(13).Value.ToString
                    _formRequest._frmREf.txt_ncm.Focus() : _formRequest._frmREf.Show() : Me.Close()
