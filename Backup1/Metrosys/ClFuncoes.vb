...
Public Class ClFuncoes
    ...
    Public Function trazTotVendBrutaDiaCup4dd(ByVal dia As Date, ByVal idImpressora As Integer, _
        ...
        cmd = New NpgsqlCommand(sql.ToString, oConnBDGENOV)
        cmd.Parameters.Add("@cp_dtemis", dia)
    ...
    Public Function trazCupomInicialDia(ByVal data As Date, ByVal idImpressora As Integer, _
        ...
        cmd = New NpgsqlCommand(sql.ToString, oConnBDGENOV)
        cmd.Parameters.Add("@no_dtemis", data)
        cmd.Parameters.Add("@no_idcdcaixa", idImpressora)
        dr = cmd.ExecuteReader
    ...
    Public Function trazDiaDoUltimoCupom(ByVal idImpressora As Integer, ByVal conexao As String) As Date
        ...
        While dr.Read
            ...
            Try
                v_ValorColuna = CDate(dr(0).ToString)
            Catch ex As Exception
            End Try
        End While
        dr.Close() : cmd = Nothing : sql = Nothing : dr = Nothing
    ...
    Public Function CX_FechadoNoDia(ByVal dataDia As Date, ByVal conexao As String) As Boolean

        Dim cxFechado As Boolean
        Dim oConnBDGENOV As NpgsqlConnection = New NpgsqlConnection(conexao)
        ...
        sql.Append("AND cx_caixa = '" & MdlUsuarioLogando._codcaixa & "' ")
        cmd = New NpgsqlCommand(sql.ToString, oConnBDGENOV)
        dr = cmd.ExecuteReader
    ...
    Public Function CX_AbertoNoDia(ByVal dataDia As Date, ByVal conexao As String) As Boolean

        Dim cxAberto As Boolean
        Dim oConnBDGENOV As NpgsqlConnection = New NpgsqlConnection(conexao)
    ...
    Public Function sldDoDia(ByVal dataDia As Date) As Double
        ...
        Dim mTotal As Double = 0.0, mSomaTotalDuplic As Double = 0.0
        ...
        'Duplicatas Normais........
        _mConsulta = "SELECT f_portad, cad.p_portad, f_duplic, Substr(f_duplic, Length(f_duplic)), f_emiss, f_vencto, nt_descrcondpagto, " & _
        "f_valor, f_juros, (f_valor + f_juros) As ""total"" FROM " & MdlEmpresaUsu._esqEstab & ".orca1pp, " & MdlEmpresaUsu._esqEstab & ".fatd001 " & _
        "LEFT JOIN cadp001 cad ON cad.p_cod = f_portad WHERE f_nfat = nt_orca AND f_dtpaga = '" & mData & "'"
        ...
        While dr.Read
            ...
            mDtEmiss = Format(CDate(dr(4)), "dd/MM/yyyy")
            mDtVencimento = Format(CDate(dr(5)), "dd/MM/yyyy")
            mDescrPagto = dr(6).ToString
            mPosiParcela = returnNumPosicaoLetraAlfab(mFaturaLetra)

            mDiasAtrazo = dataDia.Subtract(CDate(mDtVencimento)).Days
        ...
        'Duplicatas Parciais...
        _mConsulta = "SELECT f_portad, cad.p_portad, f_duplic, Substr(f_duplic, Length(f_duplic)), f_emiss, f_vencto, nt_descrcondpagto, " & _
        "f_valor, f_juros, (f_valor + f_juros) As ""total"" FROM " & MdlEmpresaUsu._esqEstab & ".orca1pp, " & MdlEmpresaUsu._esqEstab & ".fatdp02 " & _
        "LEFT JOIN cadp001 cad ON cad.p_cod = f_portad WHERE f_nfat = nt_orca AND f_dtpaga = '" & mData & "'"
        comm = New NpgsqlCommand(_mConsulta, oConnBD)
        dr = comm.ExecuteReader
        ...
        _mConsulta = "SELECT nt_codig, cad.p_portad, nt_orca, nt_dtemis, nt_dtemis, n4_tgeral " & _
        "FROM " & MdlEmpresaUsu._esqEstab & ".orca4dd, " & MdlEmpresaUsu._esqEstab & ".orca1pp " & _
        "LEFT JOIN cadp001 cad ON cad.p_cod = nt_codig WHERE nt_orca = n4_nume AND nt_dtemis = '" & mData & "' AND (nt_sit BETWEEN 3 AND 5) " & _
        "AND nt_tipo2 = 'AV' AND (nt_tiposelecao <> 1 AND nt_tiposelecao <> 2)"
        comm = New NpgsqlCommand(_mConsulta, oConnBD)
        dr = comm.ExecuteReader
        ...
        While dr.Read
            ...
            mNomeCliente = dr(1).ToString
            mFatura = dr(2).ToString
            mDtEmiss = Format(CDate(dr(3)), "dd/MM/yyyy")
            mDtVencimento = Format(CDate(dr(4)), "dd/MM/yyyy")
            mParcelas = "01"
        ...
        _mConsulta = "SELECT nt_codig, cad.p_portad, nt_orca, nt_dtemis, nt_dtemis, nt_entrada, n4_tgeral, nt_descrcondpagto " & _
        "FROM " & MdlEmpresaUsu._esqEstab & ".orca4dd, " & MdlEmpresaUsu._esqEstab & ".orca1pp " & _
        "LEFT JOIN cadp001 cad ON cad.p_cod = nt_codig WHERE nt_orca = n4_nume AND nt_dtemis = '" & mData & "' AND (nt_sit BETWEEN 3 AND 5) " & _
        "AND nt_entrada > 0 AND (nt_tiposelecao <> 1 AND nt_tiposelecao <> 2)"
        comm = New NpgsqlCommand(_mConsulta, oConnBD)
        dr = comm.ExecuteReader
        ...
        'Vendas A Prazo....
        _mConsulta = "SELECT nt_codig, cad.p_portad, nt_orca, nt_dtemis, nt_dtemis, n4_tgeral, nt_descrcondpagto " & _
        "FROM " & MdlEmpresaUsu._esqEstab & ".orca4dd, " & MdlEmpresaUsu._esqEstab & ".orca1pp " & _
        "LEFT JOIN cadp001 cad ON cad.p_cod = nt_codig WHERE nt_orca = n4_nume AND nt_dtemis = '" & mData & "' AND (nt_sit BETWEEN 3 AND 5) " & _
        "AND nt_entrada = 0 AND nt_qtdparcelas > 0"
        comm = New NpgsqlCommand(_mConsulta, oConnBD)
        dr = comm.ExecuteReader
        ...
        "WHERE d_geno = '" & MdlEmpresaUsu._codigo & "' AND d_dtpaga = '" & mData & "' ORDER BY d_duplic ASC"
        comm = New NpgsqlCommand(_mConsulta, oConnBD)
        dr = comm.ExecuteReader
        ...
        While dr.Read
            ...
            nfisc = dr(4).ToString
            emiss = Format(CDate(dr(5)), "dd/MM/yyyy")
            vencto = Format(CDate(dr(6)), "dd/MM/yyyy")
        ...
        'FINALIZANDO   ......................................
        Dim mDiaAnterior As Date = DateSerial(dataDia.Year, dataDia.Month, dataDia.Day - 1)




        mSaldoDoDia = Round((mSomaTotalDuplic + mSomaAvista + mSomaEntrada + sldAnteriorCX) - mSomaTotalDespesas, 2)
    ...
    Public Function existeReducaoZ(ByVal data As Date, ByVal idImpressora As Integer, _
        ...
        cmd = New NpgsqlCommand(sql.ToString, oConnBDGENOV)
        cmd.Parameters.Add("@cz_dtemis", data)
    ...
    Public Function trazIdGrade(ByVal objGrade As Cl_Grade, ByVal conexao As String) As Integer
        ...
        sql.Append("SELECT e_idgrade FROM " & MdlEmpresaUsu._esqVinc & ".estgrade WHERE ")
        sql.Append("e_codig = @e_codig AND e_tm = @e_tm AND e_cor = @e_cor AND e_loja = @e_loja")
        cmd = New NpgsqlCommand(sql.ToString, oConnBDGENOV)
        cmd.Parameters.Add("@e_codig", objGrade.pCodig)
        cmd.Parameters.Add("@e_tm", objGrade.pTm)
        cmd.Parameters.Add("@e_cor", objGrade.pCor)
        cmd.Parameters.Add("@e_loja", objGrade.pLoja)
    ...
    Public Function trazIndexComboBox(ByVal mBusca As String, ByVal qtdCaracteres As Int16, ByVal mComboBox As Object) As Integer
        ...
        For index = 0 To mComboBox.Items.Count - 1
            ...
            If mBusca.Equals(Trim(mComboBox.Items.Item(index).ToString.Substring(0, qtdCaracteres))) Then
                indiceCfop = index
                Exit For
            End If
    ...
    Public Function trazIndexCboLoja(ByVal mloja2Dig As String, ByVal mCboLoja As Object) As Integer
        Dim index As Integer : Dim indiceCfop As Integer = -1
    ...
    Public Function trazIndexCboLoja2(ByVal mloja As String, ByVal mCboLoja As Object) As Integer
        Dim index As Integer : Dim indiceCfop As Integer = -1
        For index = 0 To mCboLoja.Items.Count - 1
    ...
    Public Function trazSincronizaBD(ByVal mac As String, ByVal conexao As String) As Boolean
        ...
        oConn.ClearPool() : oConn.Close() : oConn = Nothing
    ...
    Public Function existNumCarne(ByVal numpedido As String, ByVal esquemaEstab As String, _
        ...
        Try
            SqlCmd.Append("SELECT f_duplic FROM " & esquemaEstab & ".fatd001 WHERE f_duplic = @f_duplic")
            Cmd = New NpgsqlCommand(SqlCmd.ToString, oConn)
    ...
    Public Function trazFornecedor(ByVal codFornecedor As String, ByRef cadp001 As Cl_Cadp001) As Boolean
        ...
        Try
            ...
            SqlParticipante.Append("p_isento, p_mun, p_coduf, p_carac, p_email, p_bairro ") '16
    ...
    Public Function existSaldoEstoque(ByVal data As Date, ByVal loja As String, ByVal tiposaldo As String, _
        ...
        Catch ex As Exception
            ...
            oConn.ClearPool() : oConn = Nothing : Return True
        End Try
...
#Region "Funções para preencher COMBOBOX"
    ...
    Public Function PreenchComboLoja(ByVal cboLoja2Dig As Object, ByVal strConection As String) As ComboBox
    ...
    Public Function PreenchComboLoja2(ByVal cboLoja As Object, ByVal strConection As String) As ComboBox
        Dim oConnLoja As NpgsqlConnection = New NpgsqlConnection(strConection)
...
#Region "Funções de Relatório"
    ...
    'Cabeçalho da Loja
    Public Sub GravCabLojOrcamentoMatricial(ByVal consulta As String, ByVal s As StreamWriter, ByVal loja As String, ByRef shouldReturn As Boolean)
    ...
    Public Sub GravCabCliOrcamentoMatricial(ByVal consulta As String, ByVal s As StreamWriter, ByVal codCliente As String, _
    ...
    End Sub
    'Grava Itens
    Public Sub GravItensOrcamentoMatricial(ByVal consulta As String, ByVal s As StreamWriter, ByVal numOrcamento As String, ByVal idOrca1 As String, _
        ...
        Try
            ...
            If drItem.HasRows = True Then
                ...
                '            123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890
                's.WriteLine("-------------------------------------------------------------------------------------")
                s.WriteLine("Cod.   Descrição.                                       Qtde      Unit.        TOTAL ")
                '            xxxxxx xxxxxxxxxZxxxxxxxxxZxxxxxxxxxZxxxxxxxxxZxxxxx 9,999.99 999,999.99 9,999,999.99  
                s.WriteLine("-------------------------------------------------------------------------------------")
            ...
            While drItem.Read
                ...
                If mContPg = 1 AndAlso mContItensPg = 27 Then
                    ...
                    s.WriteLine("+-----------------------------------------------------------------------------------+")
                    s.WriteLine(Exibe_StrEsquerda("| Cliente : " & codCliente & "-" & nomeCliente, 69) & " |ORÇ: " & numOrcamento & "|")
                    s.WriteLine("+-----------------------------------------------------------------------------------+")
                    s.WriteLine("")
                    s.WriteLine("Cod.   Descrição.                                       Qtde      Unit.        TOTAL ")
                    '            xxxxxx xxxxxxxxxZxxxxxxxxxZxxxxxxxxxZxxxxxxxxxZxxxxx 9,999.99 999,999.99 9,999,999.99  
                ...
                Exibe_StrEsquerda(mNomeProd, 45) & " " & _
            ...
            If mSomaTotProd > _valorZERO Then
                ...
                Else
                    strLinha += " - Iten "
                End If
                strLinha += Exibe_StrDireita("| " & Exibe_StrDireita(Format(Round(mSomaTotProd, 2), "#,###,##0.00"), 12) & " |", 47)
                s.WriteLine(Exibe_Str(strLinha, 85))
                s.WriteLine("------------------------------------------------------------------------------------+")
    ...
    'Cabeçalho da Loja
    Public Sub GravCabLojPedidoMatricial(ByVal consulta As String, ByVal s As StreamWriter, ByVal loja As String, ByRef shouldReturn As Boolean)
    ...
    End Sub
    'Cabeçalho do Cliente
    Public Sub GravCabCliPedidoMatricial(ByVal consulta As String, ByVal s As StreamWriter, ByVal codCliente As String, _
                                     ByVal numPedido As String, ByVal dtEmiss As String, _
                                     ByVal codVendedor As String, ByVal condicao As String, _
                                      ByVal loja As String, ByRef shouldReturn As Boolean)
        ...
        Try
            ...
            strLinha += "|" & Exibe_StrEsquerda("Emis:" & Format(CDate(dtEmiss), "dd/MM/yyyy"), 15) & "|"
            s.WriteLine(Exibe_cabecalho(strLinha, 4, 80))
    ...
    End Sub
    'Grava Itens
    Public Sub GravItensPedidoMatricial(ByVal consulta As String, ByVal s As StreamWriter, ByVal numPedido As String, ByVal idOrca1 As Int32, _
                             ByVal codCliente As String, ByVal nomeCliente As String, ByRef shouldReturn As Boolean)
        shouldReturn = False
        Try
            Dim oConnBDGENOV As New NpgsqlConnection(MdlConexaoBD.conectionPadrao)
            ...
            If drItem.HasRows = True Then
                ...
                '            123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890
                s.WriteLine("|------------------------------------------------------------------------------|")
                s.WriteLine("|COD.  |QUANT.  |UND|DESCRICÃO DO PRODUTO               |V.BRUTO |   TOTAL     |")
            ...
            While drItem.Read
                ...
                If mContPg = 1 AndAlso mContItensPg = 20 Then
                    ...
                    s.WriteLine("                    C O N T I N U A C A O . . .        FOLHA: " & String.Format("{0:D3}", mContPg))
                    s.WriteLine("+------------------------------------------------------------------------------+")
                    s.WriteLine(Exibe_StrEsquerda("| Cliente : " & codCliente & "-" & nomeCliente, 64) & " |PED: " & numPedido & "|")
                    s.WriteLine("|------------------------------------------------------------------------------|")
                    s.WriteLine("|COD.  |QUANT.  |UND|DESCRICÃO DO PRODUTO               |V.BRUTO |   TOTAL     |")
                    '             xxxxxx|9,999.99|xxx|xxxxxxxxxZxxxxxxxxxZxxxxxxxxxZxxxxx|9,999.99|   999,999.99|  
                    s.WriteLine("|------------------------------------------------------------------------------|")
                ...
                ElseIf mContPg > 1 AndAlso mContItensPg = 25 Then
                ...
                Exibe_StrDireita(Format(mVlBrutoProd, "#,##0.00"), 8) & "|" & _
                Exibe_StrDireita(Format(mVlTotBrutoProd, "###,##0.00"), 13) & "|"
            ...
            If mSomaTotProd > 0 Then
                ...
                s.WriteLine("|              |       |        |             |--------------------------------|")
                s.WriteLine("|              |       | Vol:   |" & Exibe_StrDireita(Format(Round(mSomaVolProd, 2), "#,##0.00"), 8) & " (Kg)|  T O T A L.. R$ |" & Exibe_StrDireita(Format(Round(mSomaTotProd, 2), "###,##0.00"), 14) & "|")
                s.WriteLine("+------------------------------------------------------------------------------+")
    ...
    'Cabeçalho da loja
    Public Sub GravCabLojPediMatriAlterado1(ByVal consulta As String, ByVal s As StreamWriter, ByVal loja As String, ByRef shouldReturn As Boolean)
    ...
    End Sub
    'Cabeçalho do Cliente
    Public Sub GravCabCliPediMatriAlterado1(ByVal consulta As String, ByVal s As StreamWriter, ByVal codCliente As String, _
                                     ByVal numPedido As String, ByVal dtEmiss As String, _
                                     ByVal codVendedor As String, ByVal condicao As String, _
                                      ByVal loja As String, ByRef shouldReturn As Boolean)
    ...
    End Sub
    'Grava Itens
    Public Sub GravItensPediMatriAlterado1(ByVal consulta As String, ByVal s As StreamWriter, ByVal numPedido As String, ByVal idOrca1 As Int32, _
                             ByVal codCliente As String, ByVal nomeCliente As String, ByRef shouldReturn As Boolean)
    ...
    'Titulo do Processo
    Public Sub GravTituloProcRequisicaoLaser(ByVal numRequisicao As String, ByVal dataHoje As Date, ByVal s As StreamWriter, ByRef shouldReturn As Boolean)
    ...
    End Sub
    'Cabeçalho da Loja
    Public Sub GravCabLojProcRequisicaoLaser(ByVal consulta As String, ByVal s As StreamWriter, ByVal loja As String, ByRef shouldReturn As Boolean)
    ...
    End Sub
    'Cabeçalho do Cliente
    Public Sub GravCabCliProcRequisicaoLaser(ByVal consulta As String, ByVal s As StreamWriter, _
    ...
    End Sub
    'Grava Itens
    Public Sub GravItensProcRequisicaoLaser(ByVal consulta As String, ByVal s As StreamWriter, ByVal numRequisicao As String, _
                             ByVal codCliente As String, ByVal nomeCliente As String, ByRef shouldReturn As Boolean)
        shouldReturn = False
        Dim _valorZERO As Int16 = 0
        Try
            ...
            While drItem.Read
                ...
                mQtdeProd = drItem(2)
                data = Format(CDate(drItem(3)), "dd/MM/yyyy")
    ...
    'Titulo do Processo
    Public Sub GravTituloProcSaldoContaLaser(ByVal numRequisicao As String, ByVal dataHoje As Date, ByVal s As StreamWriter, ByRef shouldReturn As Boolean)
    ...
    End Sub
    'Cabeçalho da Loja
    Public Sub GravCabLojProcSaldoContaLaser(ByVal consulta As String, ByVal s As StreamWriter, ByVal loja As String, ByRef shouldReturn As Boolean)
    ...
    End Sub
    'Cabeçalho do Cliente
    Public Sub GravCabCliProcSaldoContaLaser(ByVal consulta As String, ByVal s As StreamWriter, _
                                             ByVal codCliente As String, ByVal numRequisicao As String, _
                                             ByRef shouldReturn As Boolean)
    ...
    End Sub
    'Grava Itens
    Public Sub GravItensProcSaldoContaLaser(ByVal consulta As String, ByVal s As StreamWriter, ByVal numRequisicao As String, _
                             ByVal codCliente As String, ByVal nomeCliente As String, ByRef shouldReturn As Boolean)
        shouldReturn = False
        Dim _valorZERO As Int16 = 0
        Try
            ...
            While drItem.Read
                ...
                data = Format(CDate(drItem(4)), "dd/MM/yyyy")
    ...
    'Cabeçalho da Loja
    Public Sub GravCabLojPedidoRelatorioMatricial(ByVal consulta As String, ByVal s As StreamWriter, ByVal loja As String, ByRef shouldReturn As Boolean)
...
#Region "Funções para Tratamento do XML - NFe"
    ...
    Public Function lerXmlLoteRecebido(ByVal numLote As String, ByVal genp001 As Cl_Genp001) As String
        ...
        While xmlSTR.Equals("") AndAlso mCont <= 10 'Ler 5 segundos
    ...
    Public Function lerXmlLoteRecebidoErro(ByVal numLote As String, ByVal genp001 As Cl_Genp001) As String

        Dim xmlSTR As String = ""
        Dim mCont As Integer = 0
        Dim caminhoArquivo As String = genp001.pathRetornoXML & "\" & numLote & "-rec.err"

        While xmlSTR.Equals("") AndAlso mCont <= 3 'Ler 6 segundos

            xmlSTR = LerArquivoSalvo(caminhoArquivo)
            mCont += 1
            If xmlSTR.Equals("") Then Threading.Thread.Sleep(2000) 'Passa 2 segundos para ler novamente
