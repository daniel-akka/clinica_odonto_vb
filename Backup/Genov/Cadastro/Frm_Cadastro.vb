...
Public Class Frm_Cadastro
    ...
    Dim xoper As New ClFuncoesGenov.opera
    ...
    Private Sub AlfaMaiuscula()
        ...
        Me.txt_vendedor.CharacterCasing = CharacterCasing.Upper
...
#Region "Configura Eventos e Teclas "
    ...
    Private Sub dtp_nascativ_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dtp_nascativ.KeyDown
        If (e.KeyCode = Keys.Enter) Then
