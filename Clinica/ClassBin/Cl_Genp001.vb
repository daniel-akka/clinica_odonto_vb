Public Class Cl_Genp001
    ...
    Public pathEnvioPalm, pathRetornoPalm, ftpPalm, usuarioFtpPalm, senhaFtpPalm, pastaSgbd, logomarcapath As String
    Public pauta, descontonfe, descontopedido As Boolean
    ...
    Public Sub New()
        ...
        Me.pauta = False : Me.descontonfe = False : Me.descontopedido = True : Me.pastaSgbd = "" : Me.logomarcapath = ""
