Public Class Cl_Cadp001
    ...
    Public iddoutor, Id As Int64
    Public doutor As String
    ...
    Public Sub New()
        ...
        Me.iddoutor = 0 : Me.doutor = "" : Me.Id = 0 : Me.ficha = ""

    End Sub

    Public Sub New(vId As Int64, vCod As String, vFicha As String, vPortad As String, vDoutor As String, vCpf As String, vDtcad As Date, Optional ByVal vtipo As String = "", _
                   Optional ByVal vcarac As String = "", Optional ByVal vfantas As String = "", Optional ByVal vcivil As String = "", Optional ByVal vdtnativ As Date = Nothing, _
                   Optional ByVal vnatur As String = "", Optional ByVal vident As String = "", Optional ByVal vcgc As String = "", _
                   Optional ByVal vinsc As String = "", Optional ByVal vender As String = "", _
                Optional ByVal vbairro As String = "", Optional ByVal vcid As String = "", Optional ByVal vuf As String = "", Optional ByVal vcep As String = "", _
                Optional ByVal vfone As String = "", Optional ByVal vcelular As String = "", Optional ByVal vltrab As String = "", Optional ByVal vvendtr As String = "", Optional ByVal vfontr As String = "", _
                Optional ByVal vcargo As String = "", Optional ByVal vsalar As Double = 0.0, Optional ByVal vcrt As String = "", _
                Optional ByVal vvend As String = "", Optional ByVal vobs1 As String = "", Optional ByVal vobs2 As String = "", _
        Optional ByVal obs3 As String = "", Optional ByVal vcdvend As String = "", Optional ByVal vcdcid As String = "", Optional ByVal vbloq As String = "", _
        Optional ByVal vtb As String = "", Optional ByVal consumo As String = "", Optional ByVal vmun As String = "", Optional ByVal vcoduf As String = "", _
        Optional ByVal vfax As String = "", Optional ByVal vsexo As String = "", Optional ByVal vinativo As Boolean = False, _
        Optional ByVal visento As Boolean = False, Optional ByVal viddoutor As Integer = 0)

        Me.Id = vId
        Me.dtcad = vDtcad : Me.cod = vCod : Me.portad = vPortad
        Me.cpf = vCpf : Me.doutor = vDoutor : Me.ficha = vFicha

        Me.tipo = vtipo : Me.carac = vcarac
        Me.fantas = "" : Me.civil = "" : Me.dtnativ = Nothing : Me.natur = "" : Me.ident = ""
        Me.cgc = vcgc : Me.insc = "" : Me.pai = "" : Me.mae = "" : Me.ender = vender
        Me.bairro = vbairro : Me.cid = vcid : Me.uf = vuf : Me.cep = "" : Me.fone = vfone
        Me.ltrab = "" : Me.endtr = "" : Me.fontr = "" : Me.cargo = ""
        Me.salar = 0.0 : Me.esposo = "" : Me.crt = "" : Me.ltrabe = ""
        Me.salae = 0.0 : Me.rota = 0 : Me.vend = "" : Me.obs1 = "" : Me.obs2 = ""
        Me.obs3 = "" : Me.ultcomp = Nothing : Me.valor = 0.0 : Me.limite = 0.0
        Me.pedido = "" : Me.cdvend = "" : Me.cdcid = "" : Me.bloq = "" : Me.tb = ""
        Me.consumo = "" : Me.mun = vmun : Me.coduf = vcoduf : Me.ctactb = "" : Me.ctaanli = ""
        Me.mes = 0 : Me.fax = vfax : Me.prep = "" : Me.email = "" : Me.sexo = ""
        Me.celular = vcelular : Me.inativo = False : Me.usuario = "" : Me.isento = False
        Me.iddoutor = 0
...
#Region "   * *  Metodos Set e Get  * *   "
    ...
    Public Property pIsento() As Boolean
        Get
            Return Me.isento
        End Get
        Set(ByVal value As Boolean)
