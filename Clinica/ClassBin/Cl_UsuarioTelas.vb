Public Class Cl_UsuarioTelas
    ...
    Dim btn_cancelarExcluir As Boolean, btn_carne As Boolean, tl_movagendamento As Boolean
    'Mapas
    ...
    Public Sub New()
        ...
        tl_movpagoentregar = False : btn_cancelarExcluir = False : btn_carne = False : tl_movagendamento = False
        'Mapas
...
#Region "   * * Metodos Set e Get * *   "
    ...
    Public Property pTl_movAgendamentos() As Boolean
        Get
            Return Me.tl_movagendamento
        End Get
        Set(ByVal value As Boolean)
            Me.tl_movagendamento = value
        End Set
    End Property
