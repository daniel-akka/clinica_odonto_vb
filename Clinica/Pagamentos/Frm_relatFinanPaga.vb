...
Public Class Frm_relatFinanPaga
    ...
    Private Sub executaF6()
        ...
        executaRelatorio("", "\wged\relatorios\consultaFinPag.txt")
    End Sub
    ...
    Private Sub executaRelatorio(ByVal unidadePC As String, ByVal arqSaida As String)
        ...
        Dim mArqTemp As String = "\wged\relatorios\TEMPconsultaFinPag.TMP"
    ...
    Private Sub gravaFinanceiro(ByVal s As StreamWriter)
        ...
        Try
            ...
            Select Case Me.cbo_opcoes.SelectedIndex
                ...
                Case 0 'Doc. Pagos no Período
                    ...
                    sqlFinan.Append("WHERE cad.p_cod = Ft.d_portad AND Ft.d_sit = 'L' AND Ft.d_dtpaga BETWEEN '" & Format(Convert.ChangeType(dtp_inicial.Text, GetType(Date)), "dd/MM/yyyy") & "' AND '" & Format(Convert.ChangeType(dtp_final.Text, GetType(Date)), "dd/MM/yyyy") & "' ")
                    ...
                    'sqlFinan.Append("(cad.p_cod = Ft.d_portad AND Ft.d_sit = 'L' AND Ft.d_dtpaga BETWEEN '" & Format(Convert.ChangeType(dtp_inicial.Text), "dd/MM/yyyy") & "' AND '" & Format(Convert.ChangeType(dtp_final.Text), "dd/MM/yyyy") & "' ")
                ...
                Case 2 'Doc. a Vencer por Período
                    ...
                    sqlFinan.Append("d_banco AS ""Banco"",d_duplic AS ""Documento"", d_emiss AS ""DtEmissão"", d_vencto AS ""DtVencto"", ") '6
                    sqlFinan.Append("d_dtpaga AS ""DtPaga"", d_juros AS ""Juros R$ "", d_valor AS ""Valor R$"", cad.p_portad AS ""Portador"" ") '10
                    sqlFinan.Append("FROM fatp001 Ft LEFT JOIN cadp001 cad ON cad.p_cod = d_portad WHERE d_sit = 'N' AND Ft.d_vencto > CURRENT_DATE AND Ft.d_vencto BETWEEN '" & Format(Convert.ChangeType(dtp_inicial.Text, GetType(Date)), "dd/MM/yyyy") & "' AND '" & Format(Convert.ChangeType(dtp_final.Text, GetType(Date)), "dd/MM/yyyy") & "' ")
                ...
                Case 4 'Dupl.Pagas - Pendente
                    ...
                    sqlFinan.Append("Ft.d_vencto AS ""DtVencto"", Ft.d_dtpaga AS ""DtPaga"", Ft.d_juros AS ""Juros R$"", ") '8
                    sqlFinan.Append("Ft.d_valor AS ""Valor R$"", Pc.d_valor AS ""Parcial R$"", Pc.d_dtpaga AS ""DtPaga "", cad.p_portad AS ""Portador"" ") '12
                    sqlFinan.Append("FROM cadp001 cad, fatp001 Ft WHERE cad.p_cod = Ft.d_portad AND d_sit = 'N' AND d_cartei = '01' AND Ft.d_dtpaga BETWEEN '" & Format(Convert.ChangeType(dtp_inicial.Text, GetType(Date)), "dd/MM/yyyy") & "' AND '" & Format(Convert.ChangeType(dtp_final.Text, GetType(Date)), "dd/MM/yyyy") & "' ")
        ...
        sqlFinan.Remove(_valorZERO, sqlFinan.ToString.Length) : oConnBDGENOV.Close()
