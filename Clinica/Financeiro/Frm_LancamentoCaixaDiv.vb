...
Public Class Frm_LancamentoCaixaDiv
    ...
    Public Shared _frmREf As New Frm_LancamentoCaixaDiv
    Public incluiu As Boolean = False
    Public valorDupl As Double = 0.0
    Public valorMarcados As Double = 0.0
    Public idDuplic As String = ""
    Public _Dentista As New Cl_Doutor

    Private Sub Frm_LancamentoCaixaDiv_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then Me.Close()
    End Sub

    Private Sub Frm_LancamentoCaixaDiv_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub Frm_LancamentoCaixaDiv_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If valorMarcados > 0 Then

                txt_valor.Text = Format(valorMarcados, "###,##0.00")
                cbo_descricao.Text = "DIVERSOS - " & _Dentista.Nome
                If _Dentista.Id > 0 Then cbo_doutores.SelectedIndex = _clFuncoes.trazIndexComboBox(_Dentista.Nome, _Dentista.Nome.Length, cbo_doutores)
    ...
    Private Sub btn_incluir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_incluir.Click
        ...
        Else
            Try
                ...
                If Me.valorDupl > 0 Then Me.incluiu = True
                Me.Close()
    ...
    Sub SetaDescricao()
        Try
            cbo_descricao.Text += "  [ " & txt_comiss.Text & "% de " & txt_valor.Text & " ]"
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub cbo_doutores_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_doutores.SelectedIndexChanged
        ...
        Try
            If cbo_doutores.SelectedIndex > 0 Then
                ...
                Try
                    If cbo_protetico.SelectedIndex < 1 Then
    ...
    Private Sub cbo_protetico_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_protetico.SelectedIndexChanged
        ...
        Try
            If cbo_protetico.SelectedIndex > 0 Then
                ...
                lbl_comiss.SetBounds(384, 210, 61, 17)
                txt_comiss.SetBounds(451, 207, 55, 23)
