...
Public Class Frm_Orcamento
    ...
    Private Sub Frm_Orcamento_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.txt_valor.Text = "0,00" : Me.txt_qtde.Text = "1,00"
    ...
    Private Sub executeF5()
        ...
        Try
            If Not dtg_pedidoServico.CurrentRow.IsNewRow Then
                ...
                Me.txt_valor.Text = Format(CDbl(dtg_pedidoServico.CurrentRow.Cells(4).Value.ToString), "##,##0.00") 'dtg_pedidoprotaentrega.CurrentRow.Cells(7).Value
    ...
    Private Sub dtg_pedidoprotaentrega_RowsAdded(sender As Object, e As DataGridViewRowsAddedEventArgs) Handles dtg_pedidoServico.RowsAdded
