    ...
    Private Sub preencheDgrd_Produto(ByVal pesquisa As String)
        ...
        If oConnBDMETROSYS.State = ConnectionState.Open Then
            ...
            Try
                ...
                SqlProduto.Append("e.e_clf, el.e_pvenda FROM " & geno001.pEsquemavinc & ".est0001 e JOIN estloja01 el ON e.e_codig = el.e_codig WHERE ")
                ...
                While drProduto.Read
                    ...
                    Dg_produto.Rows.Add(codigo, nome, fornecedor, qtdEstoque, undMedida, ncmProd, _
                                        CST, CFV, GRUPO, REDUZ, sldAtual, custAnt, pcoAnt, CLF, Format(drProduto(14), "###,##0.00"))

                End While

                Dg_produto.Refresh() : drProduto.Close()
