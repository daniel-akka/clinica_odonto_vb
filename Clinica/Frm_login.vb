...
Public Class Frm_login
    ...
    Public _formRequest As New Frm_RTecSys
    ...
    Private Shared Sub validaLoginTelas(ByVal _drUsuario As NpgsqlDataReader)
        ...
        While _drUsuario.Read
            ...
            MdlTelasAcesso._usuarioTelas.pTl_movAgendamentos = _drUsuario(59)
                ...
                Try
                    ...
                    Else
                        ...
                        If _dr.HasRows = True Then
                            ...
                            _sqlUsuario.Append("tl_estrelatorios, tl_paraconfiguracao, tl_pagoaentregar, btn_carne, tl_movagendamentos ") '59
                            ...
                            _sqlUsuario.Append("gp.gp_descontopedido, g_ativempresa, g_bl_bancopadrao, g_bl_optpadrao, gp.gp_pastasgbd, ") '59
                            _sqlUsuario.Append("gp.gp_logomarcapath ") '60
                            ...
                            While _dr.Read
                                ...
                                MdlEmpresaUsu.geno001.pAtivEmpresa = _dr(56)
                                MdlEmpresaUsu.geno001.pBlBancoPadrao = _dr(57).ToString
                                MdlEmpresaUsu.geno001.pBlOptPadrao = _dr(58)


                                'Set Genp001...
                                MdlEmpresaUsu._alqIcmsInterno = _dr(10)
                                MdlEmpresaUsu._alqIcmsExterno = _dr(11)
                                MdlEmpresaUsu._alqIpi = _dr(12)
                                MdlEmpresaUsu._alqPis = _dr(13)
                                MdlEmpresaUsu._alqCofins = _dr(14)
                                MdlEmpresaUsu._alqSubst = _dr(15)
                                MdlEmpresaUsu._taxaCobranca = _dr(16)
                                ...
                                MdlEmpresaUsu.genp001.descontopedido = _dr(55)
                                MdlEmpresaUsu.genp001.pastaSgbd = _dr(59).ToString
                                MdlEmpresaUsu.genp001.logomarcapath = _dr(60).ToString
    ...
    Private Sub Frm_login_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ";Port=5432;UserId=postgres;Password=.akka.;Database=" & _clFuncoes.trazNomeBancoServidorBD(_camihoArq) & _
    ...
    Sub VerificacaoTravamento()
        ...
        Dim _clTravarPrograma As New Cl_TravaPrograma
