...
Public Class Frm_UsuariosManutencao
                ...
                If _incluindo = True Then
                    Try
                        inclueUsuario(Me.cbo_local.SelectedItem, Me.txt_nome.Text, Me.txt_login.Text, mResultado, Me.chk_privilegio.Checked, _
                          chk_bloqueado.Checked, msk_dtnascimento.Text, "", CInt(Trim(Mid(cbo_cargoUsuario.SelectedItem.ToString, 1, 2))), _
    ...
    Private Sub Frm_UsuariosManutencao_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        _oConnBDMETROSYS.Open()
        Me.Dg_usuario.Rows.Clear() : Me.Dg_usuario.Refresh() : preencheDgrd_Usuario("%")
        Me.txt_pesquisa.Focus()

        Try
            Me.cbo_local = _clFuncoes.PreenchComboLoja5Dig(cbo_local, MdlConexaoBD.conectionPadrao)
    ...
    Private Sub trazUsuarioSelecionado()
        ...
        If _oConnBDMETROSYS.State = ConnectionState.Open Then
            ...
            Try
                ...
                _sqlUsuario.Append("utl.tl_estrelatorios, utl.tl_paraconfiguracao, u.u_cargo, utl.btn_carne, u.u_codcaixa, tl_movagendamentos ") '69
                ...
                While _drUsuario.Read
                    ...
                    Try
                        Me.cbo_local.SelectedIndex = _clFuncoes.trazIndexCboLoja5dig(_drUsuario(51).ToString, Me.cbo_local)
                    Catch ex As Exception
                    ...
                    _clUsuarioTelas.pTl_movAgendamentos = _drUsuario(69)
